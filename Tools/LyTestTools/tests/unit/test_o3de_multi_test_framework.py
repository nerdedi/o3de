...
class TestResultPass(unittest.TestCase):
    def test_Create_ValidArgs_CorrectAttributes(self):
        ...
        under_test = multi_test_framework.Result.Pass(
...
class TestResultFail(unittest.TestCase):
    def test_Create_ValidArgs_CorrectAttributes(self):
        ...
        under_test = multi_test_framework.Result.Fail(
            mock_test_spec, mock_output, mock_log_output
        )
        assert mock_test_spec == under_test.test_spec
        assert mock_output == under_test.output
...
class TestResultTimeout(unittest.TestCase):
    def test_Create_ValidArgs_CorrectAttributes(self):
        ...
        under_test = multi_test_framework.Result.Timeout(
            mock_test_spec, mock_output, mock_timeout, mock_log_output
        )
        assert under_test.test_spec == mock_test_spec
        assert under_test.output == mock_output
        assert under_test.log_output == mock_log_output
...
class TestMultiTestSuite(unittest.TestCase):
    ...
    def test_TestData_ValidAP_TeardownAPOnce(self, mock_kill_processes):
        ...
        mock_test_data_generator = mock_abstract_test_suite._collected_test_data(
            mock.MagicMock()
        )
    ...
    @mock.patch(
        "ly_test_tools.o3de.multi_test_framework.MultiTestSuite.filter_session_shared_tests"
    )
    def test_PytestCustomModifyItems_FunctionsMatch_AddsRunners(
        self, mock_filter_tests
    ):
        ...
        runner_1 = multi_test_framework.MultiTestSuite.Runner(
            "mock_runner_1", mock_func_1, [mock_test]
        )
        ...
        MockTestSuite.pytest_custom_modify_items(
            mock.MagicMock(), mock_items, mock.MagicMock()
        )
    ...
    @mock.patch(
        "ly_test_tools.o3de.multi_test_framework.MultiTestSuite.get_shared_tests"
    )
    def test_GetSessionSharedTests_Valid_CallsCorrectly(
        self, mock_get_shared_tests, mock_filter_session
    ):
    ...
    @mock.patch(
        "ly_test_tools.o3de.multi_test_framework.skip_pytest_runtest_setup",
        mock.MagicMock(),
    )
    def test_FilterSessionSharedTests_OneSharedTest_ReturnsOne(self):
        ...
        selected_tests = (
            multi_test_framework.MultiTestSuite.filter_session_shared_tests(
...
class TestUtils(unittest.TestCase):
    ...
    @mock.patch("ly_test_tools.o3de.editor_test_utils.kill_all_ly_processes")
    def test_PrepareAssetProcessor_NoAP_KillAndCreateAP(
        self, mock_kill_processes, mock_proc_exists, mock_start
    ):
        mock_workspace = mock.MagicMock()
        mock_collected_test_data = mock.MagicMock()
        ...
        assert isinstance(
            mock_collected_test_data.asset_processor,
            ly_test_tools.o3de.asset_processor.AssetProcessor,
        )
    ...
    @mock.patch("ly_test_tools.environment.process_utils.process_exists")
    @mock.patch("ly_test_tools.o3de.editor_test_utils.kill_all_ly_processes")
    def test_PrepareAssetProcessor_NoAPButProcExists_NoKill(
        self, mock_kill_processes, mock_proc_exists, mock_start
    ):
        mock_workspace = mock.MagicMock()
        mock_collected_test_data = mock.MagicMock()
    ...
    def test_GetResultsUsingOutput_ValidJsonSuccess_CreatesPassResult(
        self, mock_get_module
    ):
    ...
    @mock.patch("ly_test_tools.o3de.editor_test_utils.get_module_filename")
    def test_GetResultsUsingOutput_ValidJsonFail_CreatesFailResult(
        self, mock_get_module
    ):
        mock_get_module.return_value = "mock_module_name"
        mock_test_suite = multi_test_framework.MultiTestSuite()
    ...
    @mock.patch("ly_test_tools.o3de.editor_test_utils.get_module_filename")
    def test_GetResultsUsingOutput_ModuleNotInLog_CreatesUnknownResult(
        self, mock_get_module
    ):
        ...
        assert "mock_test_name" in results.keys()
        assert isinstance(
            results["mock_test_name"], multi_test_framework.Result.Unknown
        )

    @mock.patch("ly_test_tools.o3de.editor_test_utils.get_module_filename")
    def test_GetResultsUsingOutput_MultipleTests_CreatesCorrectResults(
        self, mock_get_module
    ):
        mock_get_module.side_effect = [
            "mock_module_name_pass",
            "mock_module_name_fail",
        ...
        results = mock_test_suite._get_results_using_output(
            mock_test_list, mock_output, mock_log_output
        )
        ...
        assert isinstance(
            results["mock_test_name_pass"], multi_test_framework.Result.Pass
        )
        assert isinstance(
            results["mock_test_name_fail"], multi_test_framework.Result.Fail
        )
        assert isinstance(
            results["mock_test_name_unknown"], multi_test_framework.Result.Unknown
        )
    ...
    def test_ReportResult_TestPassed_ReportsCorrectly(self, mock_print):
        ...
        ly_test_tools.o3de.multi_test_framework.MultiTestSuite._report_result(
            mock_test_name, mock_pass
        )
...
class TestRunningTests(unittest.TestCase):
    @mock.patch(
        "ly_test_tools.o3de.multi_test_framework.MultiTestSuite._get_results_using_output"
    )
    ...
    def test_ExecSingleTest_TestSucceeds_ReturnsPass(
        self,
        mock_cycle_crash,
        ...
        assert isinstance(
            results[mock_test_spec.__name__], multi_test_framework.Result.Pass
        )
    ...
    @mock.patch("ly_test_tools.o3de.editor_test_utils.cycle_crash_report")
    @mock.patch("os.path.join", mock.MagicMock())
    def test_ExecSingleTest_TestFails_ReturnsFail(
        self,
        mock_cycle_crash,
        mock_get_testcase_filepath,
        mock_retrieve_log,
        ...
        assert isinstance(
            results[mock_test_spec.__name__], multi_test_framework.Result.Fail
        )
        assert mock_cycle_crash.called
        assert mock_executable.start.called
    ...
    def test_ExecSingleTest_TestCrashes_ReturnsCrash(
        self,
        mock_cycle_crash,
        mock_get_testcase_filepath,
        mock_retrieve_log,
        ...
        assert isinstance(
            results[mock_test_spec.__name__], multi_test_framework.Result.Crash
        )
        assert mock_executable.start.called
    ...
    @mock.patch("ly_test_tools.o3de.editor_test_utils.get_testcase_module_filepath")
    @mock.patch("ly_test_tools.o3de.editor_test_utils.cycle_crash_report")
    def test_ExecSingleTest_TestTimeout_ReturnsTimeout(
        self,
        mock_cycle_crash,
        mock_get_testcase_filepath,
        mock_retrieve_log,
        ...
        mock_test_spec = mock.MagicMock()
        mock_test_spec.__name__ = "mock_test_name"
        mock_executable.wait.side_effect = (
            ly_test_tools.launchers.exceptions.WaitTimeoutError()
        )
        mock_get_output_results.return_value = {}
        ...
        assert isinstance(
            results[mock_test_spec.__name__], multi_test_framework.Result.Timeout
        )
        assert mock_cycle_crash.called
        assert mock_executable.start.called
    ...
    def test_ExecMultitest_OneFailure_CallsCorrectFunc(
        ...
        mock_get_results.return_value = {
            "mock_test_name": mock.MagicMock(),
            "mock_test_name_2": mock.MagicMock(),
        }
    ...
    @mock.patch("os.path.basename", mock.MagicMock())
    @mock.patch("os.path.dirname", mock.MagicMock())
    def test_ExecMultitest_OneCrash_ReportsOnUnknownResult(
        self,
        mock_cycle_crash,
        mock_get_testcase_filepath,
        mock_retrieve_log,
        ...
        mock_get_testcase_filepath.side_effect = ["mock_path", "mock_path_2"]
        mock_get_results.return_value = {
            mock_test_spec.__name__: mock_unknown_result,
    ...
    @mock.patch("os.path.basename", mock.MagicMock())
    @mock.patch("os.path.dirname", mock.MagicMock())
    def test_ExecMultitest_ManyUnknown_ReportsUnknownResults(
        self,
        mock_cycle_crash,
        mock_get_testcase_filepath,
        mock_retrieve_log,
        ...
        assert isinstance(
            results[mock_test_spec_2.__name__], multi_test_framework.Result.Unknown
        )
        assert results[mock_test_spec_2.__name__].extra_info, (
            "Extra info missing from Unknown failure"
        )
    ...
    @mock.patch("ly_test_tools.o3de.editor_test_utils.get_testcase_module_filepath")
    @mock.patch("ly_test_tools.o3de.editor_test_utils.cycle_crash_report")
    def test_ExecMultitest_EditorTimeout_ReportsCorrectly(
        self,
        mock_cycle_crash,
        mock_get_testcase_filepath,
        mock_retrieve_log,
    ...
    @mock.patch(
        "ly_test_tools.o3de.multi_test_framework.MultiTestSuite._exec_single_test"
    )
    @mock.patch(
        "ly_test_tools.o3de.editor_test_utils.save_failed_asset_joblogs",
        mock.MagicMock(),
    )
    def test_RunSingleTest_ValidTest_ReportsResults(
        self, mock_exec_single_test, mock_report_result
    ):
        mock_test_suite = ly_test_tools.o3de.multi_test_framework.MultiTestSuite()
    ...
    @mock.patch(
        "ly_test_tools.o3de.multi_test_framework.MultiTestSuite._test_reporting"
    )
    @mock.patch(
        "ly_test_tools.o3de.multi_test_framework.MultiTestSuite._exec_multitest"
    )
    def test_RunBatchedTests_ValidTests_CallsCorrectly(
        self, mock_exec_multitest, mock_reporting
    ):
        mock_test_suite = ly_test_tools.o3de.multi_test_framework.MultiTestSuite()
        ...
        assert type(mock_test_suite.executable) in [
            WinAtomToolsLauncher,
            LinuxAtomToolsLauncher,
        ]
    ...
    @mock.patch(
        "ly_test_tools.o3de.multi_test_framework.MultiTestSuite._get_number_parallel_executables"
    )
    @mock.patch(
        "ly_test_tools.o3de.editor_test_utils.save_failed_asset_joblogs",
        mock.MagicMock(),
    )
    def test_RunParallelTests_TwoTestsAndExecutables_TwoThreads(
        ...
        assert mock_collected_test_data.results.update.call_count == len(
            mock_test_spec_list
        )
    ...
    def test_RunParallelTests_TenTestsAndTwoExecutables_TenThreads(
        self, mock_get_number_executables, mock_thread
    ):
        mock_test_suite = ly_test_tools.o3de.multi_test_framework.MultiTestSuite()
        mock_request = mock.MagicMock()
    ...
    def test_RunParallelTests_TenTestsAndThreeEditors_TenThreads(
        self, mock_get_number_executables, mock_thread
    ):
        mock_test_suite = ly_test_tools.o3de.multi_test_framework.MultiTestSuite()
        mock_request = mock.MagicMock()
    ...
    def test_RunParallelBatchedTests_TwoTestsAndEditors_TwoThreads(
        self, mock_get_number_executables, mock_thread
    ):
        mock_test_suite = ly_test_tools.o3de.multi_test_framework.MultiTestSuite()
        mock_request = mock.MagicMock()
    ...
    def test_RunParallelBatchedTests_TenTestsAndTwoEditors_2Threads(
        self, mock_get_number_executables, mock_thread
    ):
        mock_test_suite = ly_test_tools.o3de.multi_test_framework.MultiTestSuite()
        mock_request = mock.MagicMock()
    ...
    def test_GetNumberParallelEditors_ConfigExists_ReturnsConfig(self):
        ...
        number_of_executables = mock_test_suite._get_number_parallel_executables(
            mock_request
        )
    ...
    def test_GetNumberParallelEditors_ConfigNotExists_ReturnsDefault(self):
        ...
        assert (
            number_of_executables == mock_test_suite.get_number_parallel_executables()
        )
    ...
    def test_SetupTest_AtomExe_SetsExecutable(
        self, mock_create_atom, mock_create_editor, mock_prepare_ap, mock_kill_processes
    ):
        mock_workspace = mock.MagicMock()
    ...
    @mock.patch("ly_test_tools.launchers.launcher_helper.create_editor")
    @mock.patch("ly_test_tools.launchers.launcher_helper.create_atom_tools_launcher")
    def test_SetupTest_EditorExe_SetsExecutable(
        self, mock_create_atom, mock_create_editor, mock_prepare_ap, mock_kill_processes
    ):
        mock_test_suite = ly_test_tools.o3de.multi_test_framework.MultiTestSuite()
    ...
    def test_TestReporting_AllPassResults_NoSaveLogs(self, mock_save_logs):
        mock_test_suite = ly_test_tools.o3de.multi_test_framework.MultiTestSuite()
        mock_collected_test_data = mock.MagicMock()
        mock_pass = multi_test_framework.Result.Pass(
            mock.MagicMock(), mock.MagicMock(), mock.MagicMock()
        )
        mock_results = [mock_pass]

        mock_test_suite._test_reporting(
            mock_collected_test_data, mock_results, mock.MagicMock(), mock.MagicMock()
        )
    ...
    def test_TestReporting_ManyResults_SaveLogs(self, mock_save_logs):
        ...
        mock_fail = multi_test_framework.Result.Fail(
            mock.MagicMock(), mock.MagicMock(), mock.MagicMock()
        )
    ...
    def test_SetupCmdlineArgs_EditorExe_EnablesPrefab(self):
        ...
        under_test = mock_test_suite._setup_cmdline_args(
            None, mock_executable, mock_test_spec_list, mock.MagicMock()
        )
...
class TestMultiTestCollector(unittest.TestCase):
    def setUp(self):
        ...
        self.mock_test_class.obj.filter_shared_tests.side_effect = [
            [batch_1, batch_2],
    ...
    def test_MakeSingleRun_SingleRun_SetupTeardown(self, mock_collect):
        ...
        mock_single_run_func = (
            multi_test_framework.MultiTestSuite.MultiTestCollector._make_single_run(
    ...
    @mock.patch(
        "ly_test_tools.o3de.multi_test_framework.isinstance",
        mock.MagicMock(return_value=False),
    )
    @mock.patch(
        "ly_test_tools.o3de.multi_test_framework.issubclass",
        mock.MagicMock(return_value=False),
    )
    ...
    def test_CreateRunner_HappyPath_SetsRunnersProperly(self, mock_collect):
        ...
        multi_test_framework.MultiTestSuite.MultiTestCollector._create_runner(
            mock_runner_name, mock_function, mock_tests, mock_obj
        )
    ...
    def test_CreateRunner_MakeSharedRun_CallsAttributeFunc(self, mock_collect):
        ...
        getattr(mock_obj, mock_runner_name)(
            mock_obj,
            mock_request,
            mock_workspace,
            mock_collected_test_data,
        ...
        mock_obj.mock_func_name.assert_called_once_with(
            mock_request, mock_workspace, mock_collected_test_data, mock_tests
        )
    ...
    def test_CreateRunner_MakeResultsRun_CallsAttributeFunc(self, mock_collect):
        ...
        mock_collected_test_data.results = {
            mock_shared_test_spec_1.__name__: mock_result_1,
        ...
        getattr(mock_obj, mock_shared_test_spec_1.__name__)(
            mock_obj,
            mock.MagicMock(),
            mock.MagicMock(),
            mock_collected_test_data,
        ...
        mock_obj._report_result.assert_called_with(
            mock_shared_test_spec_1.__name__, mock_result_1
        )
        getattr(mock_obj, mock_shared_test_spec_2.__name__)(
            mock_obj,
            mock.MagicMock(),
            mock.MagicMock(),
            mock_collected_test_data,
