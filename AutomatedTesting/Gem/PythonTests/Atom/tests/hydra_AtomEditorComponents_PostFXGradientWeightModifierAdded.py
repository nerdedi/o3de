...
class Tests:
    ...
    opacity = ("Opacity property set", "P1: 'Opacity' property failed to set")
    invert_input = (
    ...
    input_max = ("Input Max property set", "P1: 'Input Max' property failed to set")
    input_min = ("Input Min property set", "P1: 'Input Min' property failed to set")
    input_mid = ("Input Mid property set", "P1: 'Input Mid' property failed to set")
    output_max = ("Output Max property set", "P1: 'Output Max' property failed to set")
    output_min = ("Output Min property set", "P1: 'Output Min' property failed to set")
    enable_transform = (
        "Enable Transform property set",
        "P1: 'Enable Transform' property failed to set",
    )
    scale = ("Scale property set", "P1: 'Scale' property failed to set")
    rotate = ("Rotate property set", "P1: 'Rotate' property failed to set")
    translate = ("Translate property set", "P1: 'Translate' property failed to set")
...
def AtomEditorComponents_PostFXGradientWeightModifier_AddedToEntity():
    ...
    with Tracer() as error_tracer:
        ...
        # Test steps begin.
        # 1. Create a PostFX Gradient Weight Modifier entity with no components.
        postfx_gradient_weight_entity = EditorEntity.create_editor_entity(
            AtomComponentProperties.postfx_gradient()
        )
        Report.critical_result(
            Tests.postfx_gradient_weight_creation,
            postfx_gradient_weight_entity.exists(),
        )
        ...
        Report.critical_result(
            ...
            postfx_gradient_weight_entity.has_component(
                AtomComponentProperties.postfx_gradient()
            ),
        )
        ...
        Report.critical_result(
            ...
            not postfx_gradient_weight_entity.has_component(
                AtomComponentProperties.postfx_gradient()
            ),
        )
        ...
        # 5. Verify PostFX Gradient Weight Modifier component not enabled.
        Report.result(
            Tests.postfx_gradient_weight_disabled,
            not postfx_gradient_weight_component.is_enabled(),
        )

        # 6. Add PostFX Layer component since it is required by the PostFX Gradient Weight Modifier component.
        postfx_gradient_weight_entity.add_component(
        ...
        Report.result(
            ...
            Math_IsClose(
                postfx_gradient_weight_component.get_component_property_value(
                    AtomComponentProperties.postfx_gradient("Opacity")
                ),
                0.9,
            ),
        )
        ...
        Report.result(
            Tests.invert_input,
            postfx_gradient_weight_component.get_component_property_value(
                AtomComponentProperties.postfx_gradient("Invert Input")
            )
            is True,
        )
        ...
        Report.result(
            Tests.enable_levels,
            postfx_gradient_weight_component.get_component_property_value(
                AtomComponentProperties.postfx_gradient("Enable Levels")
            )
            is True,
        )
        ...
        Report.result(
            ...
            Math_IsClose(
                postfx_gradient_weight_component.get_component_property_value(
                    AtomComponentProperties.postfx_gradient("Input Max")
                ),
                0.9,
            ),
        )
        ...
        Report.result(
            ...
            Math_IsClose(
                postfx_gradient_weight_component.get_component_property_value(
                    AtomComponentProperties.postfx_gradient("Input Min")
                ),
                0.1,
            ),
        )
        ...
        Report.result(
            ...
            Math_IsClose(
                postfx_gradient_weight_component.get_component_property_value(
                    AtomComponentProperties.postfx_gradient("Input Mid")
                ),
                2.0,
            ),
        )
        ...
        Report.result(
            ...
            Math_IsClose(
                postfx_gradient_weight_component.get_component_property_value(
                    AtomComponentProperties.postfx_gradient("Output Max")
                ),
                0.9,
            ),
        )
        ...
        Report.result(
            ...
            Math_IsClose(
                postfx_gradient_weight_component.get_component_property_value(
                    AtomComponentProperties.postfx_gradient("Output Min")
                ),
                0.1,
            ),
        )
        ...
        Report.result(
            ...
            postfx_gradient_weight_component.get_component_property_value(
                AtomComponentProperties.postfx_gradient("Enable Transform")
            )
            is True,
        )
        ...
        Report.result(
            Tests.scale,
            postfx_gradient_weight_component.get_component_property_value(
                AtomComponentProperties.postfx_gradient("Scale")
            )
            == x2,
        )
        ...
        Report.result(
            Tests.rotate,
            postfx_gradient_weight_component.get_component_property_value(
                AtomComponentProperties.postfx_gradient("Rotate")
            )
            == rotation,
        )
        ...
        Report.result(
            Tests.translate,
            postfx_gradient_weight_component.get_component_property_value(
                AtomComponentProperties.postfx_gradient("Translate")
            )
            == translation,
        )
        ...
        Report.result(
            Tests.is_hidden, postfx_gradient_weight_entity.is_hidden() is True
        )
        ...
        general.idle_wait_frames(1)
        Report.result(
            Tests.is_visible, postfx_gradient_weight_entity.is_visible() is True
        )
