...
class Tests:
    ...
    toggle_enable_heatmap_on = ("Heatmap enabled", "Heatmap failed to be enabled")
    toggle_enable_heatmap_off = ("Heatmap disabled", "Heatmap failed to be disabled")
...
def AtomEditorComponents_ExposureControl_AddedToEntity():
    ...
    with Tracer() as error_tracer:
        ...
        exposure_control_entity = EditorEntity.create_editor_entity(
            AtomComponentProperties.exposure_control()
        )
        Report.critical_result(
            Tests.exposure_control_creation, exposure_control_entity.exists()
        )

        # 2. Add Exposure Control component to Exposure Control entity.
        exposure_control_component = exposure_control_entity.add_component(
            AtomComponentProperties.exposure_control()
        )
        Report.critical_result(
            Tests.exposure_control_component,
            exposure_control_entity.has_component(
                AtomComponentProperties.exposure_control()
            ),
        )
        ...
        Report.result(
            Tests.exposure_control_component_removal,
            not exposure_control_entity.has_component(
                AtomComponentProperties.exposure_control()
            ),
        )
        ...
        # 5. Verify Exposure Control component not enabled.
        Report.result(
            Tests.exposure_control_disabled, not exposure_control_component.is_enabled()
        )
        ...
        # 7. Verify Exposure Control component is enabled.
        Report.result(
            Tests.exposure_control_enabled, exposure_control_component.is_enabled()
        )
        ...
        Report.result(
            ...
            exposure_control_component.get_component_property_value(
                AtomComponentProperties.exposure_control("Enable")
            )
            is False,
        )
        ...
        Report.result(
            ...
            exposure_control_component.get_component_property_value(
                AtomComponentProperties.exposure_control("Enabled Override")
            )
            is False,
        )
        ...
        exposure_control_component.set_component_property_value(
            AtomComponentProperties.exposure_control("ExposureControlType Override"),
            value=False,
        )
        Report.result(
        ...
        exposure_control_component.set_component_property_value(
            AtomComponentProperties.exposure_control("ManualCompensation Override"),
            value=0.0,
        )
        Report.result(
        ...
        exposure_control_component.set_component_property_value(
            AtomComponentProperties.exposure_control(
                "EyeAdaptationExposureMin Override"
            ),
            value=0.0,
        )
        Report.result(
        ...
        exposure_control_component.set_component_property_value(
            AtomComponentProperties.exposure_control(
                "EyeAdaptationExposureMax Override"
            ),
            value=0.0,
        )
        Report.result(
        ...
        exposure_control_component.set_component_property_value(
            AtomComponentProperties.exposure_control("EyeAdaptationSpeedUp Override"),
            value=0.0,
        )
        Report.result(
        ...
        exposure_control_component.set_component_property_value(
            AtomComponentProperties.exposure_control("EyeAdaptationSpeedDown Override"),
            value=0.0,
        )
        Report.result(
            ...
            Math_IsClose(
                exposure_control_component.get_component_property_value(
                    AtomComponentProperties.exposure_control(
                        "EyeAdaptationSpeedDown Override"
                    )
                ),
                0.0,
            ),
        ...
        exposure_control_component.set_component_property_value(
            AtomComponentProperties.exposure_control("HeatmapEnabled Override"),
            value=False,
        )
        Report.result(
        ...
        # 17. Set Control Type to Eye Adaptation.
        exposure_control_component.set_component_property_value(
            AtomComponentProperties.exposure_control("Control Type"),
            EXPOSURE_CONTROL_TYPE["eye_adaptation"],
        )
        Report.result(
        ...
        Report.result(
            ...
            Math_IsClose(
                exposure_control_component.get_component_property_value(
                    AtomComponentProperties.exposure_control("Manual Compensation")
                ),
                -16.0,
            ),
        )
        ...
        Report.result(
            ...
            Math_IsClose(
                exposure_control_component.get_component_property_value(
                    AtomComponentProperties.exposure_control("Minimum Exposure")
                ),
                -16.0,
            ),
        )
        ...
        Report.result(
            ...
            Math_IsClose(
                exposure_control_component.get_component_property_value(
                    AtomComponentProperties.exposure_control("Maximum Exposure")
                ),
                -16.0,
            ),
        )
        ...
        Report.result(
            ...
            Math_IsClose(
                exposure_control_component.get_component_property_value(
                    AtomComponentProperties.exposure_control("Speed Up")
                ),
                0.01,
            ),
        )
        ...
        Report.result(
            ...
            Math_IsClose(
                exposure_control_component.get_component_property_value(
                    AtomComponentProperties.exposure_control("Speed Down")
                ),
                0.01,
            ),
        )
        ...
        Report.result(
            ...
            exposure_control_component.get_component_property_value(
                AtomComponentProperties.exposure_control("Enable Heatmap")
            )
            is True,
        )
