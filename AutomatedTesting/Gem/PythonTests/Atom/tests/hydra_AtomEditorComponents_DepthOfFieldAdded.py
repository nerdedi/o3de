...
class Tests:
    ...
    enter_game_mode = ("P0: Entered game mode", "P0: Failed to enter game mode")
    exit_game_mode = ("P0: Exited game mode", "P0: Couldn't exit game mode")
    is_visible = ("P0: Entity is visible", "P0: Entity was not visible")
    is_hidden = ("P0: Entity is hidden", "P0: Entity was not hidden")
    entity_deleted = ("P0: Entity deleted", "P0: Entity was not deleted")
    deletion_undo = ("P0: UNDO deletion success", "P0: UNDO deletion failed")
    deletion_redo = ("P0: REDO deletion success", "P0: REDO deletion failed")
...
def AtomEditorComponents_DepthOfField_AddedToEntity():
    ...
    with Tracer() as error_tracer:
        ...
        # Test steps begin.
        # 1. Create a DepthOfField entity with no components.
        depth_of_field_entity = EditorEntity.create_editor_entity(
            AtomComponentProperties.depth_of_field()
        )
        Report.critical_result(
            Tests.depth_of_field_creation, depth_of_field_entity.exists()
        )

        # 2. Add a DepthOfField component to DepthOfField entity.
        depth_of_field_component = depth_of_field_entity.add_component(
            AtomComponentProperties.depth_of_field()
        )
        Report.critical_result(
            Tests.depth_of_field_component,
            depth_of_field_entity.has_component(
                AtomComponentProperties.depth_of_field()
            ),
        )
        ...
        # 5. Verify DepthOfField component not enabled.
        Report.result(
            Tests.depth_of_field_component_disabled,
            not depth_of_field_component.is_enabled(),
        )

        # 6. Add Post FX Layer component since it is required by the DepthOfField component.
        depth_of_field_entity.add_component(AtomComponentProperties.postfx_layer())
        Report.result(
            Tests.post_fx_component,
            depth_of_field_entity.has_component(AtomComponentProperties.postfx_layer()),
        )

        # 7. Verify DepthOfField component is enabled.
        Report.result(
            Tests.depth_of_field_component_enabled,
            depth_of_field_component.is_enabled(),
        )
        ...
        Report.result(
            ...
            depth_of_field_component.get_component_property_value(
                AtomComponentProperties.depth_of_field("Enable Depth of Field")
            )
            is True,
        )
        ...
        Report.result(
            ...
            depth_of_field_component.get_component_property_value(
                AtomComponentProperties.depth_of_field("CameraEntityId Override")
            )
            is True,
        )
        ...
        Report.result(
            ...
            depth_of_field_component.get_component_property_value(
                AtomComponentProperties.depth_of_field("Enabled Override")
            )
            is True,
        )
        ...
        Report.result(
            ...
            depth_of_field_component.get_component_property_value(
                AtomComponentProperties.depth_of_field("QualityLevel Override")
            )
            is True,
        )
        ...
        Report.result(
            ...
            depth_of_field_component.get_component_property_value(
                AtomComponentProperties.depth_of_field("ApertureF Override")
            )
            == 0.0,
        )
        ...
        Report.result(
            ...
            depth_of_field_component.get_component_property_value(
                AtomComponentProperties.depth_of_field("FocusDistance Override")
            )
            == 0.0,
        )
        ...
        Report.result(
            ...
            depth_of_field_component.get_component_property_value(
                AtomComponentProperties.depth_of_field("EnableAutoFocus Override")
            )
            is True,
        )
        ...
        depth_of_field_component.set_component_property_value(
            AtomComponentProperties.depth_of_field("AutoFocusScreenPosition Override"),
            0.0,
        )
        Report.result(
            ...
            depth_of_field_component.get_component_property_value(
                AtomComponentProperties.depth_of_field(
                    "AutoFocusScreenPosition Override"
                )
            )
            == 0.0,
        )
        ...
        Report.result(
            ...
            depth_of_field_component.get_component_property_value(
                AtomComponentProperties.depth_of_field("AutoFocusSensitivity Override")
            )
            == 0.0,
        )
        ...
        Report.result(
            ...
            depth_of_field_component.get_component_property_value(
                AtomComponentProperties.depth_of_field("AutoFocusSpeed Override")
            )
            == 0.0,
        )
        ...
        Report.result(
            ...
            depth_of_field_component.get_component_property_value(
                AtomComponentProperties.depth_of_field("AutoFocusDelay Override")
            )
            == 0.0,
        )
        ...
        Report.result(
            ...
            depth_of_field_component.get_component_property_value(
                AtomComponentProperties.depth_of_field("EnableDebugColoring Override")
            )
            is True,
        )
        ...
        Report.result(
            ...
            depth_of_field_component.get_component_property_value(
                AtomComponentProperties.depth_of_field("Quality Level")
            )
            == 0,
        )
        ...
        Report.result(
            ...
            depth_of_field_component.get_component_property_value(
                AtomComponentProperties.depth_of_field("Aperture F")
            )
            == 0.0,
        )
        ...
        Report.result(
            Tests.f_number,
            depth_of_field_component.get_component_property_value(
                AtomComponentProperties.depth_of_field("F Number")
            )
            == 0.239887535572052,
        )
        ...
        Report.result(
            Tests.enable_auto_focus_off,
            depth_of_field_component.get_component_property_value(
                AtomComponentProperties.depth_of_field("Enable Auto Focus")
            )
            is False,
        )
        ...
        Report.result(
            ...
            depth_of_field_component.get_component_property_value(
                AtomComponentProperties.depth_of_field("Focus Distance")
            )
            == 0.0,
        )
        ...
        Report.result(
            ...
            depth_of_field_component.get_component_property_value(
                AtomComponentProperties.depth_of_field("Auto Focus Sensitivity")
            )
            == 0.0,
        )
        ...
        Report.result(
            ...
            depth_of_field_component.get_component_property_value(
                AtomComponentProperties.depth_of_field("Auto Focus Speed")
            )
            == 0.0,
        )
        ...
        Report.result(
            Tests.auto_focus_delay_set_to_1,
            depth_of_field_component.get_component_property_value(
                AtomComponentProperties.depth_of_field("Auto Focus Delay")
            )
            == 1.0,
        )
        ...
        Report.result(
            ...
            depth_of_field_component.get_component_property_value(
                AtomComponentProperties.depth_of_field("Enable Debug Color")
            )
            is True,
        )
