...
def AtomGPU_LightComponent_AreaLightScreenshotsMatchGoldenImages():
    ...
    with Tracer() as error_tracer:
        ...
        Report.critical_result(
            Tests.area_light_entity_created, area_light_entity.exists()
        )

        # 2. Add a Light component to the Area Light entity.
        light_component = area_light_entity.add_component(
            AtomComponentProperties.light()
        )
        Report.critical_result(
            Tests.light_component_added,
            area_light_entity.has_component(AtomComponentProperties.light()),
        )
        ...
        Report.result(
            ...
            == light_component_color_value,
        )

        # 5. Enter game mode and take a screenshot then exit game mode.
        enter_exit_game_mode_take_screenshot(
            "AreaLight_1.png", Tests.enter_game_mode, Tests.exit_game_mode
        )

        # 6. Set the Intensity property of the Light component to 0.0.
        light_component.set_component_property_value(
            AtomComponentProperties.light("Intensity"), 0.0
        )
        Report.result(
        ...
        light_component.set_component_property_value(
            ...
            ATTENUATION_RADIUS_MODE["automatic"],
        )
        Report.result(
        ...
        # 8. Enter game mode and take a screenshot then exit game mode.
        enter_exit_game_mode_take_screenshot(
            "AreaLight_2.png", Tests.enter_game_mode, Tests.exit_game_mode
        )

        # 9. Set the Intensity property of the Light component to 1000.0
        light_component.set_component_property_value(
            AtomComponentProperties.light("Intensity"), 1000.0
        )
        Report.result(
            Tests.light_component_intensity_property_set,
            light_component.get_component_property_value(
        ...
        # 10. Enter game mode and take a screenshot then exit game mode.
        enter_exit_game_mode_take_screenshot(
            "AreaLight_3.png", Tests.enter_game_mode, Tests.exit_game_mode
        )
        ...
        # 12. Enter game mode and take a screenshot then exit game mode.
        enter_exit_game_mode_take_screenshot(
            "AreaLight_4.png", Tests.enter_game_mode, Tests.exit_game_mode
        )
        ...
        # 14. Enter game mode and take a screenshot then exit game mode.
        enter_exit_game_mode_take_screenshot(
            "AreaLight_5.png", Tests.enter_game_mode, Tests.exit_game_mode
        )
