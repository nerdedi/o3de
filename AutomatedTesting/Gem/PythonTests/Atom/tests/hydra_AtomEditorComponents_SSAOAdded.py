...
def AtomEditorComponents_SSAO_AddedToEntity():
    ...
    with Tracer() as error_tracer:
        ...
        ssao_component.set_component_property_value(
            AtomComponentProperties.ssao("Enable SSAO"), False
        )
        Report.result(
            Tests.enable_ssao,
            ssao_component.get_component_property_value(
                AtomComponentProperties.ssao("Enable SSAO")
            )
            is False,
        )

        ssao_component.set_component_property_value(
            AtomComponentProperties.ssao("Enable SSAO"), True
        )
        Report.result(
            Tests.enable_ssao,
            ssao_component.get_component_property_value(
        ...
        # 9. Toggle Enable Blur False (default True)
        ssao_component.set_component_property_value(
            AtomComponentProperties.ssao("Enable Blur"), False
        )
        Report.result(
            Tests.enable_blur,
            ssao_component.get_component_property_value(
                AtomComponentProperties.ssao("Enable Blur")
            )
            is False,
        )

        ssao_component.set_component_property_value(
            AtomComponentProperties.ssao("Enable Blur"), True
        )
        Report.result(
            Tests.enable_blur,
            ssao_component.get_component_property_value(
        ...
        # 10. Set SSAO Strength to high/low values then return to default
        ssao_component.set_component_property_value(
            AtomComponentProperties.ssao("SSAO Strength"), 2.0
        )
        Report.result(
            Tests.set_ssao_strength,
            ssao_component.get_component_property_value(
                AtomComponentProperties.ssao("SSAO Strength")
            )
            == 2.0,
        )

        ssao_component.set_component_property_value(
            AtomComponentProperties.ssao("SSAO Strength"), 0.0
        )
        Report.result(
            Tests.set_ssao_strength,
            ssao_component.get_component_property_value(
        ...
        ssao_component.set_component_property_value(
            AtomComponentProperties.ssao("SSAO Strength"), 1.0
        )

        # 11. Set Sample Radius to high/low values then return to default
        ssao_component.set_component_property_value(
            AtomComponentProperties.ssao("Sampling Radius"), 0.25
        )
        Report.result(
            Tests.set_sample_radius,
            ssao_component.get_component_property_value(
                AtomComponentProperties.ssao("Sampling Radius")
            )
            == 0.25,
        )

        ssao_component.set_component_property_value(
            AtomComponentProperties.ssao("Sampling Radius"), 0.0
        )
        Report.result(
            Tests.set_sample_radius,
            ssao_component.get_component_property_value(
        ...
        ssao_component.set_component_property_value(
            AtomComponentProperties.ssao("Sampling Radius"), 0.05
        )

        # 12. Set Blur Strength to high/low values then return to default
        ssao_component.set_component_property_value(
            AtomComponentProperties.ssao("Blur Strength"), 1.0
        )
        Report.result(
            Tests.set_blur_strength,
            ssao_component.get_component_property_value(
                AtomComponentProperties.ssao("Blur Strength")
            )
            == 1.0,
        )

        ssao_component.set_component_property_value(
            AtomComponentProperties.ssao("Blur Strength"), 0.0
        )
        Report.result(
            Tests.set_blur_strength,
            ssao_component.get_component_property_value(
        ...
        ssao_component.set_component_property_value(
            AtomComponentProperties.ssao("Blur Strength"), 0.85
        )

        # 13. Set Blur Edge Threshold to high/low values
        ssao_component.set_component_property_value(
            AtomComponentProperties.ssao("Blur Edge Threshold"), 1.0
        )
        Report.result(
            Tests.set_blur_edge_threshold,
            ssao_component.get_component_property_value(
                AtomComponentProperties.ssao("Blur Edge Threshold")
            )
            == 1.0,
        )

        ssao_component.set_component_property_value(
            AtomComponentProperties.ssao("Blur Edge Threshold"), 0.0
        )
        Report.result(
            Tests.set_blur_edge_threshold,
            ssao_component.get_component_property_value(
        ...
        # 14. Set Blur Sharpness to high/low values then return to default
        ssao_component.set_component_property_value(
            AtomComponentProperties.ssao("Blur Sharpness"), 400.0
        )
        Report.result(
            Tests.set_blur_sharpness,
            ssao_component.get_component_property_value(
                AtomComponentProperties.ssao("Blur Sharpness")
            )
            == 400.0,
        )

        ssao_component.set_component_property_value(
            AtomComponentProperties.ssao("Blur Sharpness"), 0.0
        )
        Report.result(
            Tests.set_blur_sharpness,
            ssao_component.get_component_property_value(
        ...
        ssao_component.set_component_property_value(
            AtomComponentProperties.ssao("Blur Sharpness"), 200.0
        )

        # 15. Toggle Enable Downsample (default True)
        ssao_component.set_component_property_value(
            AtomComponentProperties.ssao("Enable Downsample"), False
        )
        Report.result(
            Tests.enable_downsample,
            ssao_component.get_component_property_value(
                AtomComponentProperties.ssao("Enable Downsample")
            )
            is False,
        )

        ssao_component.set_component_property_value(
            AtomComponentProperties.ssao("Enable Downsample"), True
        )
        Report.result(
            Tests.enable_downsample,
            ssao_component.get_component_property_value(
        ...
        # 16. Toggle Enabled Override (default True)
        ssao_component.set_component_property_value(
            AtomComponentProperties.ssao("Enabled Override"), False
        )
        Report.result(
            Tests.enable_downsample,
            ssao_component.get_component_property_value(
                AtomComponentProperties.ssao("Enabled Override")
            )
            is False,
        )

        ssao_component.set_component_property_value(
            AtomComponentProperties.ssao("Enabled Override"), True
        )
        Report.result(
            Tests.enable_downsample,
            ssao_component.get_component_property_value(
        ...
        # 17. Set Strength Override to 0.0 then return to default 1.0
        ssao_component.set_component_property_value(
            AtomComponentProperties.ssao("Strength Override"), 0.0
        )
        Report.result(
            Tests.set_strength_override,
            ssao_component.get_component_property_value(
                AtomComponentProperties.ssao("Strength Override")
            )
            == 0.0,
        )

        ssao_component.set_component_property_value(
            AtomComponentProperties.ssao("Strength Override"), 1.0
        )
        Report.result(
            Tests.set_strength_override,
            ssao_component.get_component_property_value(
        ...
        # 18. Set SamplingRadius Override to 0.0 then return to default 1.0
        ssao_component.set_component_property_value(
            AtomComponentProperties.ssao("SamplingRadius Override"), 0.0
        )
        Report.result(
            Tests.set_samplingradius_override,
            ssao_component.get_component_property_value(
                AtomComponentProperties.ssao("SamplingRadius Override")
            )
            == 0.0,
        )

        ssao_component.set_component_property_value(
            AtomComponentProperties.ssao("SamplingRadius Override"), 1.0
        )
        Report.result(
            Tests.set_samplingradius_override,
            ssao_component.get_component_property_value(
        ...
        # 19. Toggle EnableBlur Override (default True)
        ssao_component.set_component_property_value(
            AtomComponentProperties.ssao("EnableBlur Override"), False
        )
        Report.result(
            Tests.enable_blur_override,
            ssao_component.get_component_property_value(
                AtomComponentProperties.ssao("EnableBlur Override")
            )
            is False,
        )

        ssao_component.set_component_property_value(
            AtomComponentProperties.ssao("EnableBlur Override"), True
        )
        Report.result(
            Tests.enable_blur_override,
            ssao_component.get_component_property_value(
        ...
        Report.result(
            ...
            ssao_component.get_component_property_value(
                AtomComponentProperties.ssao("BlurConstFalloff Override")
            )
            == 0.0,
        )
        ...
        Report.result(
            ...
            ssao_component.get_component_property_value(
                AtomComponentProperties.ssao("BlurDepthFalloffStrength Override")
            )
            == 0.0,
        )
        ...
        Report.result(
            ...
            ssao_component.get_component_property_value(
                AtomComponentProperties.ssao("BlurDepthFalloffThreshold Override")
            )
            == 0.0,
        )
        ...
        # 23. Toggle EnableDownsample Override (default true)
        ssao_component.set_component_property_value(
            AtomComponentProperties.ssao("EnableDownsample Override"), False
        )
        Report.result(
            Tests.enable_downsample_override,
            ssao_component.get_component_property_value(
                AtomComponentProperties.ssao("EnableDownsample Override")
            )
            is False,
        )

        ssao_component.set_component_property_value(
            AtomComponentProperties.ssao("EnableDownsample Override"), True
        )
        Report.result(
            Tests.enable_downsample_override,
            ssao_component.get_component_property_value(
