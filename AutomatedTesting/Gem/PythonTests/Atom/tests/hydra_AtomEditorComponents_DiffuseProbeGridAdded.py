...
class Tests:
    ...
    scrolling = ("Scaling property set", "P1: Scaling property failed to set correctly")
    show_visualization = (
...
def AtomEditorComponents_DiffuseProbeGrid_AddedToEntity():
    ...
    with Tracer() as error_tracer:
        ...
        # Test steps begin.
        # 1. Create a Diffuse Probe Grid entity with no components.
        diffuse_probe_grid_entity = EditorEntity.create_editor_entity(
        ...
        Report.critical_result(
            ...
            diffuse_probe_grid_entity.has_component(
                AtomComponentProperties.diffuse_probe_grid()
            ),
        )
        ...
        # 5. Verify Diffuse Probe Grid component not enabled.
        Report.result(
            Tests.diffuse_probe_grid_disabled,
            not diffuse_probe_grid_component.is_enabled(),
        )
        ...
        for shape in AtomComponentProperties.diffuse_probe_grid("shapes"):
            ...
            Report.result(
                Tests.diffuse_probe_grid_enabled,
                diffuse_probe_grid_component.is_enabled(),
            )
            ...
            if not (shape == AtomComponentProperties.diffuse_probe_grid("shapes")[-1]):
                ...
                TestHelper.wait_for_condition(
                    lambda: not diffuse_probe_grid_entity.has_component(shape), 1.0
                )
                Report.result(
                    Tests.diffuse_probe_grid_disabled,
                    not diffuse_probe_grid_component.is_enabled(),
        ...
        Report.result(
            ...
            diffuse_probe_grid_component.get_component_property_value(
                AtomComponentProperties.diffuse_probe_grid("Scrolling")
            )
            is True,
        )
        ...
        Report.result(
            ...
            diffuse_probe_grid_component.get_component_property_value(
                AtomComponentProperties.diffuse_probe_grid("Show Inactive Probes")
            )
            is True,
        )
        ...
        Report.result(
            ...
            diffuse_probe_grid_component.get_component_property_value(
                AtomComponentProperties.diffuse_probe_grid("Show Visualization")
            )
            is True,
        )
        ...
        # 11. 'Visualization Sphere Radius' (0.1 to very large float unbound)
        diffuse_probe_grid_component.set_component_property_value(
            AtomComponentProperties.diffuse_probe_grid("Visualization Sphere Radius"),
            0.1,
        )
        Report.result(
        ...
        Report.result(
            ...
            Math_IsClose(
                diffuse_probe_grid_component.get_component_property_value(
                    AtomComponentProperties.diffuse_probe_grid("Normal Bias")
                ),
                1.0,
            ),
        )
        ...
        Report.result(
            ...
            Math_IsClose(
                diffuse_probe_grid_component.get_component_property_value(
                    AtomComponentProperties.diffuse_probe_grid("Ambient Multiplier")
                ),
                10.0,
            ),
        )
        ...
        Report.result(
            ...
            Math_IsClose(
                diffuse_probe_grid_component.get_component_property_value(
                    AtomComponentProperties.diffuse_probe_grid("View Bias")
                ),
                1.0,
            ),
        )
        ...
        for rays in NUM_RAYS_PER_PROBE:
            ...
            diffuse_probe_grid_component.set_component_property_value(
                AtomComponentProperties.diffuse_probe_grid("Number of Rays Per Probe"),
                NUM_RAYS_PER_PROBE[rays],
            )
            Report.result(
                test_rays,
                diffuse_probe_grid_component.get_component_property_value(
