...
def AtomEditorComponents_EntityReference_AddedToEntity():
    ...
    with Tracer() as error_tracer:
        ...
        # Test steps begin.
        # 1. Create an Entity Reference entity with no components.
        entity_reference_entity = EditorEntity.create_editor_entity(
            AtomComponentProperties.entity_reference()
        )
        Report.critical_result(
            Tests.entity_reference_creation, entity_reference_entity.exists()
        )
        ...
        Report.critical_result(
            ...
            entity_reference_entity.has_component(
                AtomComponentProperties.entity_reference()
            ),
        )
        ...
        # 10. Reset the container property then put one entity reference back for further tests
        entity_reference_component.reset_container(
            AtomComponentProperties.entity_reference("EntityIdReferences")
        )
        general.idle_wait_frames(1)
        Report.result(
        ...
        # 11. Remove component
        entity_reference_entity.remove_component(
            AtomComponentProperties.entity_reference()
        )
        general.idle_wait_frames(1)
        Report.result(
            Tests.entity_reference_component_removed,
            not entity_reference_entity.has_component(
                AtomComponentProperties.entity_reference()
            ),
        )
