...
class Tests:
    ...
    light_component_added = ("Light component added", "Couldn't add Light component")
...
def AtomGPU_LightComponent_SpotLightScreenshotsMatchGoldenImages():
    ...
    with Tracer() as error_tracer:
        ...
        # Test steps begin.
        # 1. Find the Directional Light entity then disable its Directional Light component.
        directional_light_entity = EditorEntity.find_editor_entity(
        ...
        Report.critical_result(
            Tests.directional_light_component_disabled,
            not directional_light_component.is_enabled(),
        )

        # 2. Disable Global Skylight (IBL) component on the Global Skylight (IBL) entity.
        global_skylight_entity = EditorEntity.find_editor_entity(
        ...
        Report.critical_result(
            Tests.global_skylight_component_disabled,
            not global_skylight_component.is_enabled(),
        )
        ...
        Report.critical_result(
            Tests.hdri_skybox_component_disabled, not hdri_skybox_component.is_enabled()
        )
        ...
        Report.critical_result(
            Tests.spot_light_entity_created, spot_light_entity.exists()
        )

        # 5. Attach a Light component to the Spot Light entity.
        light_component = spot_light_entity.add_component(
            AtomComponentProperties.light()
        )
        Report.critical_result(
            Tests.light_component_added, light_component.is_enabled()
        )
        ...
        # 7. Enter game mode and take a screenshot then exit game mode.
        enter_exit_game_mode_take_screenshot(
            "SpotLight_1.png", Tests.enter_game_mode, Tests.exit_game_mode
        )
        ...
        ground_plane_material_component = ground_plane_entity.get_components_of_type(
            [ground_plane_material_component_name]
        )[0]
        ...
        # 9. Enter game mode and take a screenshot then exit game mode.
        enter_exit_game_mode_take_screenshot(
            "SpotLight_2.png", Tests.enter_game_mode, Tests.exit_game_mode
        )
        ...
        # 11. Enter game mode and take a screenshot then exit game mode.
        enter_exit_game_mode_take_screenshot(
            "SpotLight_3.png", Tests.enter_game_mode, Tests.exit_game_mode
        )

        # 12. Change the Light component Color property value.
        color_value = azlmbr.math.Color(
            47.0 / 255.0, 75.0 / 255.0, 37.0 / 255.0, 255.0 / 255.0
        )
        light_component.set_component_property_value(
        ...
        # 13. Enter game mode and take a screenshot then exit game mode.
        enter_exit_game_mode_take_screenshot(
            "SpotLight_4.png", Tests.enter_game_mode, Tests.exit_game_mode
        )
        ...
        light_component.set_component_property_value(
            AtomComponentProperties.light("Inner angle"), inner_angle
        )
        light_component.set_component_property_value(
        ...
        # 15. Enter game mode and take a screenshot then exit game mode.
        enter_exit_game_mode_take_screenshot(
            "SpotLight_5.png", Tests.enter_game_mode, Tests.exit_game_mode
        )
        ...
        # 17. Enter game mode and take a screenshot then exit game mode.
        enter_exit_game_mode_take_screenshot(
            "SpotLight_6.png", Tests.enter_game_mode, Tests.exit_game_mode
        )
