...
def AtomEditorComponents_ReflectionProbe_AddedToEntity():
    ...
    with Tracer() as error_tracer:
        ...
        # Test steps begin.
        # 1. Create a Reflection Probe entity with no components.
        reflection_probe_entity = EditorEntity.create_editor_entity(
            AtomComponentProperties.reflection_probe()
        )
        Report.critical_result(
            Tests.reflection_probe_creation, reflection_probe_entity.exists()
        )

        # 2. Add a Reflection Probe component to Reflection Probe entity.
        reflection_probe_component = reflection_probe_entity.add_component(
            AtomComponentProperties.reflection_probe()
        )
        Report.critical_result(
            Tests.reflection_probe_component,
            reflection_probe_entity.has_component(
                AtomComponentProperties.reflection_probe()
            ),
        )
        ...
        # 5. Verify Reflection Probe component not enabled.
        Report.result(
            Tests.reflection_probe_disabled, not reflection_probe_component.is_enabled()
        )
        ...
        for shape in AtomComponentProperties.reflection_probe("shapes"):
            ...
            Report.result(
                Tests.reflection_probe_enabled, reflection_probe_component.is_enabled()
            )
            ...
            if not (shape == AtomComponentProperties.reflection_probe("shapes")[-1]):
                ...
                TestHelper.wait_for_condition(
                    lambda: not reflection_probe_entity.has_component(shape), 1.0
                )
                Report.result(
                    Tests.reflection_probe_disabled,
                    not reflection_probe_component.is_enabled(),
                )
        ...
        Report.result(
            ...
            reflection_probe_component.get_component_property_value(
                AtomComponentProperties.reflection_probe("Use Baked Cubemap")
            )
            is False,
        )
        ...
        Report.result(
            ...
            reflection_probe_component.get_component_property_value(
                AtomComponentProperties.reflection_probe("Show Visualization")
            )
            is False,
        )
        ...
        Report.result(
            ...
            Math_IsClose(
                reflection_probe_component.get_component_property_value(
                    AtomComponentProperties.reflection_probe("Bake Exposure")
                ),
                -20.0,
            ),
        )
        ...
        Report.result(
            ...
            Math_IsClose(
                reflection_probe_component.get_component_property_value(
                    AtomComponentProperties.reflection_probe("Height")
                ),
                0.0,
            ),
        )
        ...
        Report.result(
            ...
            Math_IsClose(
                reflection_probe_component.get_component_property_value(
                    AtomComponentProperties.reflection_probe("Length")
                ),
                0.0,
            ),
        )
        ...
        Report.result(
            ...
            Math_IsClose(
                reflection_probe_component.get_component_property_value(
                    AtomComponentProperties.reflection_probe("Width")
                ),
                0.0,
            ),
        )
        ...
        Report.result(
            ...
            Math_IsClose(
                reflection_probe_component.get_component_property_value(
                    AtomComponentProperties.reflection_probe("Settings Exposure")
                ),
                -20.0,
            ),
        )
        ...
        for quality in BAKED_CUBEMAP_QUALITY:
            ...
            reflection_probe_component.set_component_property_value(
                AtomComponentProperties.reflection_probe("Baked Cubemap Quality"),
                BAKED_CUBEMAP_QUALITY[quality],
            )
            Report.result(
                test_quality,
                reflection_probe_component.get_component_property_value(
