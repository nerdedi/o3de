...
def AtomEditorComponents_ChromaticAberration_AddedToEntity():
    ...
    with Tracer() as error_tracer:
        ...
        # Test steps begin.
        # 1. Create an Chromatic Aberration entity with no components.
        chromatic_aberration_entity = EditorEntity.create_editor_entity(
            AtomComponentProperties.chromatic_aberration()
        )
        Report.critical_result(
            Tests.chromatic_aberration_creation, chromatic_aberration_entity.exists()
        )

        # 2. Add Chromatic Aberration component to Chromatic Aberration entity.
        chromatic_aberration_component = chromatic_aberration_entity.add_component(
            AtomComponentProperties.chromatic_aberration()
        )
        Report.critical_result(
            Tests.chromatic_aberration_component,
            chromatic_aberration_entity.has_component(
                AtomComponentProperties.chromatic_aberration()
            ),
        )
        ...
        Report.critical_result(
            Tests.chromatic_aberration_component_removal,
            not chromatic_aberration_entity.has_component(
                AtomComponentProperties.chromatic_aberration()
            ),
        )
        ...
        # 5. Verify Chromatic Aberration component not enabled.
        Report.result(
            Tests.chromatic_aberration_disabled,
            not chromatic_aberration_component.is_enabled(),
        )

        # 6. Add PostFX Layer component since it is required by the Chromatic Aberration component.
        chromatic_aberration_entity.add_component(
        ...
        # 7. Verify Chromatic Aberration component is enabled.
        Report.result(
            Tests.chromatic_aberration_enabled,
            chromatic_aberration_component.is_enabled(),
        )

        # 8. Enable/Disable the "Enable Chromatic Aberration" parameter.
        # Enable the "Enable Chromatic Aberration" parameter.
        chromatic_aberration_component.set_component_property_value(
            AtomComponentProperties.chromatic_aberration("Enable Chromatic Aberration"),
            True,
        )
        Report.result(
        ...
        Report.result(
            ...
            chromatic_aberration_component.get_component_property_value(
                AtomComponentProperties.chromatic_aberration("Enabled Override")
            )
            is False,
        )
        ...
        Report.result(
            ...
            chromatic_aberration_component.get_component_property_value(
                AtomComponentProperties.chromatic_aberration("Strength Override")
            )
            == 0.0,
        )
        ...
        Report.result(
            ...
            chromatic_aberration_component.get_component_property_value(
                AtomComponentProperties.chromatic_aberration("Blend Override")
            )
            == 0.0,
        )
        ...
        Report.result(
            Tests.strength_min,
            chromatic_aberration_component.get_component_property_value(
                AtomComponentProperties.chromatic_aberration("Strength")
            )
            == 0.0,
        )
        ...
        Report.result(
            Tests.blend_min,
            chromatic_aberration_component.get_component_property_value(
                AtomComponentProperties.chromatic_aberration("Blend")
            )
            == 0.0,
        )
        ...
        general.idle_wait_frames(1)
        Report.result(
            Tests.is_visible, chromatic_aberration_entity.is_visible() is True
        )
