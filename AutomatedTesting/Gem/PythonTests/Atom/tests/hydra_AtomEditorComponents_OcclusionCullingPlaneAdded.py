...
def AtomEditorComponents_OcclusionCullingPlane_AddedToEntity():
    ...
    with Tracer() as error_tracer:
        ...
        # 2. Add a occlusion culling plane component to occlusion culling plane entity.
        occlusion_culling_plane_component = (
            occlusion_culling_plane_entity.add_component(
                AtomComponentProperties.occlusion_culling_plane()
            )
        )
        Report.critical_result(
            Tests.occlusion_culling_plane_component_added,
            occlusion_culling_plane_entity.has_component(
                AtomComponentProperties.occlusion_culling_plane()
            ),
        )
        ...
        Report.result(
            ...
            occlusion_culling_plane_component.get_component_property_value(
                AtomComponentProperties.occlusion_culling_plane("Show Visualization")
            )
            is False,
        )
        ...
        Report.result(
            Tests.scale, occlusion_culling_plane_entity.get_local_uniform_scale() == 5.0
        )
        ...
        Report.result(
            Tests.is_hidden, occlusion_culling_plane_entity.is_hidden() is True
        )
        ...
        general.idle_wait_frames(1)
        Report.result(
            Tests.is_visible, occlusion_culling_plane_entity.is_visible() is True
        )
