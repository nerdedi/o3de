...
class Tests:
    ...
    show_sun = ("Show sun property set", "P1: 'Show sun' property failed to set")
    sun_color = ("Sun color property set", "P1: 'Sun color' property failed to set")
    sun_falloff_factor = (
    ...
    fast_sky = ("Fast sky property set", "P1: 'Fast sky' property failed to set")
    max_samples = (
    ...
    near_clip = ("Near Clip property set", "P1: 'Near Clip' property failed to set")
    near_fade_distance = (
...
def AtomEditorComponents_SkyAtmosphere_AddedToEntity():
    ...
    with Tracer() as error_tracer:
        ...
        # Test steps begin.
        # 1. Create an Sky Atmosphere entity with no components.
        sky_atmosphere_entity = EditorEntity.create_editor_entity(
            AtomComponentProperties.sky_atmosphere()
        )
        Report.critical_result(
            Tests.sky_atmosphere_creation, sky_atmosphere_entity.exists()
        )

        # 2. Add Sky Atmosphere component to Sky Atmosphere entity.
        sky_atmosphere_component = sky_atmosphere_entity.add_component(
            AtomComponentProperties.sky_atmosphere()
        )
        Report.critical_result(
            Tests.sky_atmosphere_component,
            sky_atmosphere_entity.has_component(
                AtomComponentProperties.sky_atmosphere()
            ),
        )
        ...
        Report.critical_result(
            Tests.sky_atmosphere_component_removal,
            not sky_atmosphere_entity.has_component(
                AtomComponentProperties.sky_atmosphere()
            ),
        )
        ...
        # 5. Verify Sky Atmosphere component is enabled.
        Report.result(
            Tests.sky_atmosphere_enabled, sky_atmosphere_component.is_enabled()
        )

        # 6. Set a value for 'Ground albedo' property
        sky_atmosphere_component.set_component_property_value(
            AtomComponentProperties.sky_atmosphere("Ground albedo"),
            Vector3(0.0, 1.0, 0.0),
        )
        Report.result(
            Tests.ground_albedo,
        ...
        Report.result(
            Tests.ground_radius,
            sky_atmosphere_component.get_component_property_value(
                AtomComponentProperties.sky_atmosphere("Ground radius")
            )
            == 100000.0,
        )
        ...
        for origin_type in ATMOSPHERE_ORIGIN:
            ...
            sky_atmosphere_component.set_component_property_value(
                AtomComponentProperties.sky_atmosphere("Origin"),
                ATMOSPHERE_ORIGIN[origin_type],
            )
            Report.result(
                test_origin,
                sky_atmosphere_component.get_component_property_value(
        ...
        sky_atmosphere_component.set_component_property_value(
            AtomComponentProperties.sky_atmosphere("Origin"),
            ATMOSPHERE_ORIGIN["GroundAtWorldOrigin"],
        )
        ...
        Report.result(
            ...
            sky_atmosphere_component.get_component_property_value(
                AtomComponentProperties.sky_atmosphere("Atmosphere height")
            )
            == 10000.0,
        )
        ...
        # 10. Set a value for 'Illuminance factor' property
        sky_atmosphere_component.set_component_property_value(
            AtomComponentProperties.sky_atmosphere("Illuminance factor"),
        ...
        Report.result(
            ...
            sky_atmosphere_component.get_component_property_value(
                AtomComponentProperties.sky_atmosphere("Mie absorption scale")
            )
            == 1.0,
        )
        ...
        # 12. Set a value for 'Mie absorption' property
        sky_atmosphere_component.set_component_property_value(
            AtomComponentProperties.sky_atmosphere("Mie absorption"),
            Vector3(0.5, 0.0, 0.5),
        )
        Report.result(
        ...
        # 13. Set a value for 'Mie exponential distribution' property
        sky_atmosphere_component.set_component_property_value(
            AtomComponentProperties.sky_atmosphere("Mie exponential distribution"),
            400.0,
        )
        Report.result(
        ...
        Report.result(
            ...
            sky_atmosphere_component.get_component_property_value(
                AtomComponentProperties.sky_atmosphere("Mie scattering scale")
            )
            == 1.0,
        )
        ...
        # 15. Set a value for 'Mie scattering' property
        sky_atmosphere_component.set_component_property_value(
            AtomComponentProperties.sky_atmosphere("Mie scattering"),
            Vector3(1.0, 0.0, 0.0),
        )
        Report.result(
        ...
        Report.result(
            ...
            sky_atmosphere_component.get_component_property_value(
                AtomComponentProperties.sky_atmosphere("Ozone absorption scale")
            )
            == 1.0,
        )
        ...
        # 17. Set a value for 'Ozone Absorption' property
        sky_atmosphere_component.set_component_property_value(
            AtomComponentProperties.sky_atmosphere("Ozone absorption"),
            Vector3(0.5, 0.5, 0.0),
        )
        Report.result(
        ...
        # 18. Set a value for 'Rayleigh exponential distribution' property
        sky_atmosphere_component.set_component_property_value(
            AtomComponentProperties.sky_atmosphere("Rayleigh exponential distribution"),
            400.0,
        )
        Report.result(
        ...
        Report.result(
            ...
            sky_atmosphere_component.get_component_property_value(
                AtomComponentProperties.sky_atmosphere("Rayleigh scattering scale")
            )
            == 1.0,
        )
        ...
        # 20. Set a value for 'Rayleigh scattering' property
        sky_atmosphere_component.set_component_property_value(
            AtomComponentProperties.sky_atmosphere("Rayleigh scattering"),
            Vector3(1.0, 1.0, 1.0),
        )
        Report.result(
        ...
        Report.result(
            Tests.show_sun,
            sky_atmosphere_component.get_component_property_value(
                AtomComponentProperties.sky_atmosphere("Show sun")
            )
            is False,
        )
        ...
        # 22. Set a value for 'Sun color' property
        sky_atmosphere_component.set_component_property_value(
            AtomComponentProperties.sky_atmosphere("Sun color"),
        ...
        Report.result(
            ...
            sky_atmosphere_component.get_component_property_value(
                AtomComponentProperties.sky_atmosphere("Sun falloff factor")
            )
            == 200.0,
        )
        ...
        # 24. Set a value for 'Sun limb color' property
        sky_atmosphere_component.set_component_property_value(
            AtomComponentProperties.sky_atmosphere("Sun limb color"),
            Color(0.0, 0.0, 0.0, 255.0),
        )
        Report.result(
        ...
        Report.result(
            ...
            sky_atmosphere_component.get_component_property_value(
                AtomComponentProperties.sky_atmosphere("Sun luminance factor")
            )
            == 100000.0,
        )
        ...
        Report.result(
            ...
            sky_atmosphere_component.get_component_property_value(
                AtomComponentProperties.sky_atmosphere("Sun orientation")
            )
            == sun_entity.id,
        )
        ...
        Report.result(
            ...
            sky_atmosphere_component.get_component_property_value(
                AtomComponentProperties.sky_atmosphere("Sun radius factor")
            )
            == 100.0,
        )
        ...
        Report.result(
            ...
            sky_atmosphere_component.get_component_property_value(
                AtomComponentProperties.sky_atmosphere("Enable shadows")
            )
            is True,
        )
        ...
        Report.result(
            Tests.fast_sky,
            sky_atmosphere_component.get_component_property_value(
                AtomComponentProperties.sky_atmosphere("Fast sky")
            )
            is False,
        )
        ...
        Report.result(
            Tests.max_samples,
            sky_atmosphere_component.get_component_property_value(
                AtomComponentProperties.sky_atmosphere("Max samples")
            )
            == 64,
        )
        ...
        Report.result(
            Tests.min_samples,
            sky_atmosphere_component.get_component_property_value(
                AtomComponentProperties.sky_atmosphere("Min samples")
            )
            == 64,
        )
        ...
        Report.result(
            Tests.near_clip,
            sky_atmosphere_component.get_component_property_value(
                AtomComponentProperties.sky_atmosphere("Near clip")
            )
            == 10.0,
        )
        ...
        Report.result(
            ...
            sky_atmosphere_component.get_component_property_value(
                AtomComponentProperties.sky_atmosphere("Near fade distance")
            )
            == 20.0,
        )
