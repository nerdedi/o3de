...
def AtomEditorComponents_HDRColorGrading_AddedToEntity():
    ...
    with Tracer() as error_tracer:
        ...
        Report.result(
            Tests.color_adjustment_weight_min_value,
            hdr_color_grading_component.get_component_property_value(
                AtomComponentProperties.hdr_color_grading("Color Adjustment Weight")
            )
            == 0.0,
        )
        ...
        Report.result(
            Tests.color_adjustment_weight_max_value,
            hdr_color_grading_component.get_component_property_value(
                AtomComponentProperties.hdr_color_grading("Color Adjustment Weight")
            )
            == 1.0,
        ...
        Report.result(
            Tests.exposure_low_value,
            hdr_color_grading_component.get_component_property_value(
                AtomComponentProperties.hdr_color_grading("Exposure")
            )
            == -20.0,
        )
        ...
        Report.result(
            Tests.contrast_min_value,
            hdr_color_grading_component.get_component_property_value(
                AtomComponentProperties.hdr_color_grading("Contrast")
            )
            == -100.0,
        )
        ...
        Report.result(
            Tests.pre_saturation_min_value,
            hdr_color_grading_component.get_component_property_value(
                AtomComponentProperties.hdr_color_grading("Pre Saturation")
            )
            == -100.0,
        )
        ...
        Report.result(
            Tests.pre_saturation_max_value,
            hdr_color_grading_component.get_component_property_value(
                AtomComponentProperties.hdr_color_grading("Pre Saturation")
            )
            == 100.0,
        ...
        Report.result(
            Tests.filter_intensity_low_value,
            hdr_color_grading_component.get_component_property_value(
                AtomComponentProperties.hdr_color_grading("Filter Intensity")
            )
            == -1.0,
        )
        ...
        Report.result(
            Tests.filter_intensity_high_value,
            hdr_color_grading_component.get_component_property_value(
                AtomComponentProperties.hdr_color_grading("Filter Intensity")
            )
            == 1.0,
        ...
        Report.result(
            Tests.filter_multiply_min_value,
            hdr_color_grading_component.get_component_property_value(
                AtomComponentProperties.hdr_color_grading("Filter Multiply")
            )
            == -1.0,
        )
        ...
        Report.result(
            Tests.filter_multiply_max_value,
            hdr_color_grading_component.get_component_property_value(
                AtomComponentProperties.hdr_color_grading("Filter Multiply")
            )
            == 1.0,
        ...
        Report.result(
            Tests.edit_filter_swatch_color, filter_color_value.IsClose(violet_color)
        )
        ...
        Report.result(
            Tests.white_balance_weight_max_value,
            hdr_color_grading_component.get_component_property_value(
                AtomComponentProperties.hdr_color_grading("White Balance Weight")
            )
            == 1.0,
        )
        ...
        Report.result(
            Tests.temperature_min_value,
            hdr_color_grading_component.get_component_property_value(
                AtomComponentProperties.hdr_color_grading("Temperature")
            )
            == 1000.0,
        )
        ...
        Report.result(
            Tests.tint_min_value,
            hdr_color_grading_component.get_component_property_value(
                AtomComponentProperties.hdr_color_grading("Tint")
            )
            == -100.0,
        )
        ...
        Report.result(
            Tests.luminance_preservation_min_value,
            hdr_color_grading_component.get_component_property_value(
                AtomComponentProperties.hdr_color_grading("Luminance Preservation")
            )
            == -1.0,
        )
        ...
        Report.result(
            Tests.luminance_preservation_max_value,
            hdr_color_grading_component.get_component_property_value(
                AtomComponentProperties.hdr_color_grading("Luminance Preservation")
            )
            == 1.0,
        ...
        Report.result(
            Tests.split_toning_weight_max_value,
            hdr_color_grading_component.get_component_property_value(
                AtomComponentProperties.hdr_color_grading("Split Toning Weight")
            )
            == 1.0,
        )
        ...
        Report.result(
            Tests.balance_min_value,
            hdr_color_grading_component.get_component_property_value(
                AtomComponentProperties.hdr_color_grading("Balance")
            )
            == -1.0,
        )
        ...
        st_shadows_color_value = (
            hdr_color_grading_component.get_component_property_value(
                AtomComponentProperties.hdr_color_grading("Split Toning Shadows Color")
            )
        )
        Report.result(
            Tests.edit_split_toning_shadow_color,
            st_shadows_color_value.IsClose(st_shadows_color),
        )
        ...
        st_highlights_color_value = (
            hdr_color_grading_component.get_component_property_value(
                AtomComponentProperties.hdr_color_grading(
                    "Split Toning Highlights Color"
                )
            )
        )
        Report.result(
            Tests.edit_split_toning_highlights_color,
            st_highlights_color_value.IsClose(st_highlights_color),
        )
        ...
        Report.result(
            Tests.smh_weight_max_value,
            hdr_color_grading_component.get_component_property_value(
                AtomComponentProperties.hdr_color_grading("SMH Weight")
            )
            == 1.0,
        )
        ...
        Report.result(
            Tests.shadows_start_max_value,
            hdr_color_grading_component.get_component_property_value(
                AtomComponentProperties.hdr_color_grading("Shadows Start")
            )
            == 16.0,
        )
        ...
        Report.result(
            Tests.shadows_end_min_value,
            hdr_color_grading_component.get_component_property_value(
                AtomComponentProperties.hdr_color_grading("Shadows End")
            )
            == 0.0,
        )
        ...
        Report.result(
            Tests.highlights_start_min_value,
            hdr_color_grading_component.get_component_property_value(
                AtomComponentProperties.hdr_color_grading("Highlights Start")
            )
            == 0.0,
        )
        ...
        Report.result(
            Tests.highlights_start_max_value,
            hdr_color_grading_component.get_component_property_value(
                AtomComponentProperties.hdr_color_grading("Highlights Start")
            )
            == 16.0,
        ...
        Report.result(
            Tests.highlights_end_min_value,
            hdr_color_grading_component.get_component_property_value(
                AtomComponentProperties.hdr_color_grading("Highlights End")
            )
            == 0.0,
        )
        ...
        Report.result(
            Tests.highlights_end_max_value,
            hdr_color_grading_component.get_component_property_value(
                AtomComponentProperties.hdr_color_grading("Highlights End")
            )
            == 16.0,
        ...
        smh_shadows_color_value = (
            hdr_color_grading_component.get_component_property_value(
                AtomComponentProperties.hdr_color_grading("SMH Shadows Color")
            )
        )
        Report.result(
            Tests.edit_smh_shadows_color,
            smh_shadows_color_value.IsClose(smh_shadows_color),
        )
        ...
        smh_midtones_color_value = (
            hdr_color_grading_component.get_component_property_value(
                AtomComponentProperties.hdr_color_grading("SMH Midtones Color")
            )
        )
        Report.result(
            Tests.edit_smh_midtones_color,
            smh_midtones_color_value.IsClose(smh_midtones_color),
        )
        ...
        hdr_color_grading_component.set_component_property_value(
            ...
            smh_highlights_color,
        )
        smh_highlights_color_value = (
            hdr_color_grading_component.get_component_property_value(
                AtomComponentProperties.hdr_color_grading("SMH Highlights Color")
            )
        )
        Report.result(
            Tests.edit_smh_highlights_color,
            smh_highlights_color_value.IsClose(smh_highlights_color),
        )
        ...
        channel_red_color_value = (
            hdr_color_grading_component.get_component_property_value(
                AtomComponentProperties.hdr_color_grading("Channel Mixing Red")
            )
        )
        Report.result(
            Tests.edit_channel_mixing_red,
            channel_red_color_value.IsClose(channel_red_color),
        )
        ...
        channel_green_color_value = (
            hdr_color_grading_component.get_component_property_value(
                AtomComponentProperties.hdr_color_grading("Channel Mixing Green")
            )
        )
        Report.result(
            Tests.edit_channel_mixing_green,
            channel_green_color_value.IsClose(channel_green_color),
        )
        ...
        channel_blue_color_value = (
            hdr_color_grading_component.get_component_property_value(
                AtomComponentProperties.hdr_color_grading("Channel Mixing Blue")
            )
        )
        Report.result(
            Tests.edit_channel_mixing_blue,
            channel_blue_color_value.IsClose(channel_blue_color),
        )
        ...
        Report.result(
            Tests.final_adjustment_weight_min_value,
            hdr_color_grading_component.get_component_property_value(
                AtomComponentProperties.hdr_color_grading("Final Adjustment Weight")
            )
            == 0.0,
        )
        ...
        Report.result(
            Tests.final_adjustment_weight_max_value,
            hdr_color_grading_component.get_component_property_value(
                AtomComponentProperties.hdr_color_grading("Final Adjustment Weight")
            )
            == 1.0,
        ...
        Report.result(
            Tests.post_saturation_min_value,
            hdr_color_grading_component.get_component_property_value(
                AtomComponentProperties.hdr_color_grading("Post Saturation")
            )
            == -100.0,
        )
        ...
        Report.result(
            Tests.post_saturation_max_value,
            hdr_color_grading_component.get_component_property_value(
                AtomComponentProperties.hdr_color_grading("Post Saturation")
            )
            == 100.0,
        ...
        Report.result(
            Tests.hue_shift_max_value,
            hdr_color_grading_component.get_component_property_value(
                AtomComponentProperties.hdr_color_grading("Hue Shift")
            )
            == 1.0,
        )
