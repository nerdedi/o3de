...
def AtomEditorComponents_DirectionalLight_AddedToEntity():
    ...
    with Tracer() as error_tracer:
        ...
        # Test steps begin.
        # 1. Create a Directional Light entity with no components.
        directional_light_entity = EditorEntity.create_editor_entity(
            AtomComponentProperties.directional_light()
        )
        Report.critical_result(
            Tests.directional_light_creation, directional_light_entity.exists()
        )

        # 2. Add Directional Light component to Directional Light entity.
        directional_light_component = directional_light_entity.add_component(
            AtomComponentProperties.directional_light()
        )
        Report.critical_result(
        ...
        # 8. Intensity mode set to Lux then back to Ev100.
        directional_light_component.set_component_property_value(
            AtomComponentProperties.directional_light("Intensity mode"),
            DIRECTIONAL_LIGHT_INTENSITY_MODE["Lux"],
        )
        Report.result(
        ...
        directional_light_component.set_component_property_value(
            AtomComponentProperties.directional_light("Intensity mode"),
            DIRECTIONAL_LIGHT_INTENSITY_MODE["Ev100"],
        )
        general.idle_wait_frames(1)
        Report.result(
        ...
        Report.result(
            ...
            directional_light_component.get_component_property_value(
                AtomComponentProperties.directional_light("Intensity")
            )
            == 10.0,
        )
        ...
        Report.result(
            Tests.angular_diameter_set_to_1,
            Math_IsClose(
                directional_light_component.get_component_property_value(
                    AtomComponentProperties.directional_light("Angular diameter")
                ),
                1.0,
            ),
        )
        ...
        general.idle_wait_frames(1)
        Report.result(
            Tests.angular_diameter_set_to_default,
            Math_IsClose(
                directional_light_component.get_component_property_value(
                    AtomComponentProperties.directional_light("Angular diameter")
                ),
        ...
        # 11. Add Camera entity.
        camera_entity = EditorEntity.create_editor_entity(
        ...
        Report.result(
            Tests.intensity_set_to_10,
            directional_light_component.get_component_property_value(
                AtomComponentProperties.directional_light("Shadow far clip")
            )
            == 2000.0,
        )
        ...
        Report.result(
            ...
            directional_light_component.get_component_property_value(
                AtomComponentProperties.directional_light("Shadowmap size")
            )
            == 256,
        )
        ...
        Report.result(
            ...
            directional_light_component.get_component_property_value(
                AtomComponentProperties.directional_light("Cascade count")
            )
            == 2,
        )
        ...
        Report.result(
            Tests.split_ratio_can_be_set_to_three_tenths,
            Math_IsClose(
                directional_light_component.get_component_property_value(
                    AtomComponentProperties.directional_light("Split ratio")
                ),
                0.3,
            ),
        )
        ...
        general.idle_wait_frames(1)
        Report.result(
            Tests.split_ratio_can_be_set_to_default,
            Math_IsClose(
                directional_light_component.get_component_property_value(
                    AtomComponentProperties.directional_light("Split ratio")
                ),
        ...
        Report.result(
            ...
            directional_light_component.get_component_property_value(
                AtomComponentProperties.directional_light("Automatic splitting")
            )
            is False,
        )
        ...
        # 19. Far depth cascade can be set to test value then back to the default value.
        directional_light_component.set_component_property_value(
            AtomComponentProperties.directional_light("Far depth cascade"),
            Vector4(15.0, 40.0, 65.0, 90.0),
        )
        Report.result(
        ...
        Report.result(
            ...
            directional_light_component.get_component_property_value(
                AtomComponentProperties.directional_light("Cascade correction")
            )
            is True,
        )
        ...
        Report.result(
            ...
            directional_light_component.get_component_property_value(
                AtomComponentProperties.directional_light("Ground height")
            )
            == 10.0,
        )
        ...
        Report.result(
            ...
            directional_light_component.get_component_property_value(
                AtomComponentProperties.directional_light("Debug coloring")
            )
            is True,
        )
        ...
        # 25. Set Shadow filter method to PCF for subsequent tests.
        directional_light_component.set_component_property_value(
            AtomComponentProperties.directional_light("Shadow filter method"),
            DIRECTIONAL_LIGHT_SHADOW_FILTER_METHOD["PCF"],
        )
        Report.result(
        ...
        Report.result(
            ...
            directional_light_component.get_component_property_value(
                AtomComponentProperties.directional_light("Filtering sample count")
            )
            == 50,
        )
        ...
        Report.result(
            Tests.shadow_bias_set_to_one_tenth,
            Math_IsClose(
                directional_light_component.get_component_property_value(
                    AtomComponentProperties.directional_light("Shadow Bias")
                ),
                0.1,
            ),
        )
        ...
        general.idle_wait_frames(1)
        Report.result(
            Tests.shadow_bias_count_set_to_default,
            Math_IsClose(
                directional_light_component.get_component_property_value(
                    AtomComponentProperties.directional_light("Shadow Bias")
                ),
        ...
        Report.result(
            Tests.normal_shadow_bias_set_to_seven,
            Math_IsClose(
                directional_light_component.get_component_property_value(
                    AtomComponentProperties.directional_light("Normal Shadow Bias")
                ),
                7.0,
            ),
        )
        ...
        general.idle_wait_frames(1)
        Report.result(
            Tests.normal_shadow_bias_count_set_to_default,
            Math_IsClose(
                directional_light_component.get_component_property_value(
                    AtomComponentProperties.directional_light("Normal Shadow Bias")
                ),
        ...
        Report.result(
            ...
            directional_light_component.get_component_property_value(
                AtomComponentProperties.directional_light("Blend between cascades")
            )
            is True,
        )
        ...
        directional_light_component.set_component_property_value(
            AtomComponentProperties.directional_light("Shadow filter method"),
            DIRECTIONAL_LIGHT_SHADOW_FILTER_METHOD["ESM"],
        )
        Report.result(
        ...
        directional_light_component.set_component_property_value(
            AtomComponentProperties.directional_light("Shadow filter method"),
            DIRECTIONAL_LIGHT_SHADOW_FILTER_METHOD["PCF+ESM"],
        )
        Report.result(
        ...
        directional_light_component.set_component_property_value(
            AtomComponentProperties.directional_light("Shadow filter method"),
            DIRECTIONAL_LIGHT_SHADOW_FILTER_METHOD["None"],
        )
        Report.result(
        ...
        Report.result(
            ...
            directional_light_component.get_component_property_value(
                AtomComponentProperties.directional_light("Fullscreen Blur")
            )
            is False,
        )
        ...
        Report.result(
            Tests.fullscreen_blur_strength_set_to_zero,
            Math_IsClose(
                directional_light_component.get_component_property_value(
                    AtomComponentProperties.directional_light(
        ...
        general.idle_wait_frames(1)
        Report.result(
            Tests.fullscreen_blur_strength_set_to_default,
            Math_IsClose(
                directional_light_component.get_component_property_value(
                    AtomComponentProperties.directional_light(
                        "Fullscreen Blur Strength"
        ...
        directional_light_component.set_component_property_value(
            AtomComponentProperties.directional_light("Fullscreen Blur Sharpness"),
            240.0,
        )
        Report.result(
            Tests.fullscreen_blur_sharpness_set_to_240,
            Math_IsClose(
                directional_light_component.get_component_property_value(
                    AtomComponentProperties.directional_light(
        ...
        general.idle_wait_frames(1)
        Report.result(
            Tests.fullscreen_blur_sharpness_set_to_default,
            Math_IsClose(
                directional_light_component.get_component_property_value(
                    AtomComponentProperties.directional_light(
                        "Fullscreen Blur Sharpness"
        ...
        Report.result(
            ...
            directional_light_component.get_component_property_value(
                AtomComponentProperties.directional_light("Affects GI")
            )
            is False,
        )
        ...
        Report.result(
            Tests.factor_set_to_2,
            Math_IsClose(
                directional_light_component.get_component_property_value(
                    AtomComponentProperties.directional_light("Factor")
                ),
                2.0,
            ),
        )
