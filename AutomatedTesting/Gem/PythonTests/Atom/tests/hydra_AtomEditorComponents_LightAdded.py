...
class Tests:
    ...
    edit_light_color = ("Light color updated", "P1: Light color failed to update")
    edit_intensity_value = ("Intensity updated", "P1: Intensity failed to update")
    edit_attenuation_radius = (
        "Attenuation radius Radius updated",
        "P1: Attenuation radius Radius failed to update",
    )
    enable_shadows = ("Shadows enabled", "P1: Shadows failed to be enabled")
    disable_shadows = ("Shadows disabled", "P1: Shadows failed to be disabled")
    edit_shadow_bias = ("Shadow Bias updated", "P1: Shadow Bias failed to be updated")
    edit_normal_bias = (
    ...
    edit_esm_exponent = ("ESM exponent updated", "P1: ESM exponent failed to update")
    edit_inner_angle = (
    ...
    disable_shutters = ("Shutters disabled", "P1: Shutters failed to be disabled")
    enable_shutters = ("Shutters enabled", "P1: Shutters failed to be enabled")
...
def AtomEditorComponents_Light_AddedToEntity():
    ...
    with Tracer() as error_tracer:
        ...
        # Test steps begin.
        # 1. Create a Light entity with no components.
        light_entity = EditorEntity.create_editor_entity(
            AtomComponentProperties.light()
        )
        ...
        for light_type in light_types_copy.keys():
            ...
            light_component = light_entity.add_component(
                AtomComponentProperties.light()
            )
            ...
            # 6. Check for Shape component.
            if LIGHT_TYPES[light_type] in (
                LIGHT_TYPES["sphere"],
                LIGHT_TYPES["spot_disk"],
                LIGHT_TYPES["capsule"],
                LIGHT_TYPES["quad"],
                LIGHT_TYPES["polygon"],
            ):
            ...
            light_component.set_component_property_value(
                AtomComponentProperties.light("Color"), color_value
            )
            general.idle_wait_frames(1)
            ...
            if LIGHT_TYPES[light_type] not in (
                LIGHT_TYPES["simple_point"],
                LIGHT_TYPES["simple_spot"],
            ):
            ...
            for radius_mode in ATTENUATION_RADIUS_MODE.keys():
                light_component.set_component_property_value(
                    ...
                    ATTENUATION_RADIUS_MODE[radius_mode],
                )
                general.idle_wait_frames(1)
                ...
                if (
                    ATTENUATION_RADIUS_MODE[radius_mode]
                    == ATTENUATION_RADIUS_MODE["explicit"]
                ):
                    light_component.set_component_property_value(
                    ...
                    general.idle_wait_frames(1)
                    Report.result(
                        Tests.edit_attenuation_radius,
                        light_component.get_component_property_value(
                            AtomComponentProperties.light("Attenuation radius Radius")
                        )
                        == 1000,
                    )
            ...
            if LIGHT_TYPES[light_type] in (
                ...
                Report.result(
                    ...
                    light_component.get_component_property_value(
                        AtomComponentProperties.light("Enable shadow")
                    )
                    is True,
                )
                ...
                Report.result(
                    ...
                    light_component.get_component_property_value(
                        AtomComponentProperties.light("Shadows Bias")
                    )
                    == 100,
                )
                ...
                Report.result(
                    ...
                    light_component.get_component_property_value(
                        AtomComponentProperties.light("Normal shadow bias")
                    )
                    == 10,
                )
                ...
                for filter_method in SHADOW_FILTER_METHOD.keys():
                    light_component.set_component_property_value(
                        ...
                        SHADOW_FILTER_METHOD[filter_method],
                    )
                    general.idle_wait_frames(1)
                    ...
                    # 17. Edit the Filtering sample count parameter.
                    if SHADOW_FILTER_METHOD[filter_method] in (
                        SHADOW_FILTER_METHOD["PCF"],
                        ...
                        general.idle_wait_frames(1)
                        Report.result(
                            Tests.edit_filtering_sample_count,
                            light_component.get_component_property_value(
                                AtomComponentProperties.light("Filtering sample count")
                            )
                            == 64,
                        )
                    ...
                    if SHADOW_FILTER_METHOD[filter_method] in (
                        ...
                        general.idle_wait_frames(1)
                        Report.result(
                            Tests.edit_esm_exponent,
                            light_component.get_component_property_value(
                                AtomComponentProperties.light("ESM exponent")
                            )
                            == 5000,
                        )
            ...
            if LIGHT_TYPES[light_type] in (
                ...
                general.idle_wait_frames(1)
                Report.result(
                    Tests.edit_inner_angle,
                    light_component.get_component_property_value(
                        AtomComponentProperties.light("Inner angle")
                    )
                    == 0.5,
                )
                ...
                general.idle_wait_frames(1)
                Report.result(
                    Tests.edit_outer_angle,
                    light_component.get_component_property_value(
                        AtomComponentProperties.light("Outer angle")
                    )
                    == 90,
                )
            ...
            if LIGHT_TYPES[light_type] == LIGHT_TYPES["spot_disk"]:
                ...
                Report.result(
                    ...
                    light_component.get_component_property_value(
                        AtomComponentProperties.light("Enable shutters")
                    )
                    is False,
                )
            ...
            if LIGHT_TYPES[light_type] in (LIGHT_TYPES["quad"], LIGHT_TYPES["polygon"]):
                ...
                Report.result(
                    ...
                    light_component.get_component_property_value(
                        AtomComponentProperties.light("Both directions")
                    )
                    is True,
                )
            ...
            if LIGHT_TYPES[light_type] == LIGHT_TYPES["quad"]:
                ...
                Report.result(
                    ...
                    light_component.get_component_property_value(
                        AtomComponentProperties.light("Fast approximation")
                    )
                    is True,
                )
