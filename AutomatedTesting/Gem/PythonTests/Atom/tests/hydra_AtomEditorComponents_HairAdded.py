...
class Tests:
    ...
    hair_disabled = ("Hair component disabled", "P0: Hair component was not disabled.")
    actor_component = (
        "Entity has an Actor component",
        "P0: Entity did not have an Actor component",
    )
    hair_enabled = ("Hair component enabled", "P0: Hair component was not enabled.")
    hair_asset = (
    ...
    enable_ibl = ("Enable IBL property set", "P1: 'Enable IBL' property failed to set")
    enable_longitude = (
    ...
    base_color = ("Base Color property set", "P1: 'Base Color' property failed to set")
    enable_hair_lod = (
    ...
    hair_ex1 = ("Hair Ex1 property set", "P1: 'Hair Ex1' property failed to set")
    hair_ex2 = ("Hair Ex2 property set", "P1: 'Hair Ex2' property failed to set")
    hair_kdiffuse = (
        "Hair Kdiffuse property set",
        "P1: 'Hair Kdiffuse' property failed to set",
    )
    hair_ks1 = ("Hair Ks1 property set", "P1: 'Hair Ks1' property failed to set")
    hair_ks2 = ("Hair Ks2 property set", "P1: 'Hair Ks2' property failed to set")
    hair_roughness = (
    ...
    damping = ("Damping property set", "P1: 'Damping' property failed to set")
    ...
    vsp_coeffs = ("Vsp Coeffs property set", "P1: 'Vsp Coeffs' property failed to set")
    wind_angle_radians = (
...
def AtomEditorComponents_Hair_AddedToEntity():
    ...
    with Tracer() as error_tracer:
        ...
        Report.result(
            Tests.actor_component,
            hair_entity.has_component(AtomComponentProperties.actor()),
        )
        ...
        head_path = os.path.join(
            "testdata",
            "headbonechainhairstyle",
            "test_hair_bone_chain_head_style.fbx.azmodel",
        )
        head_asset = Asset.find_asset_by_path(head_path)
        hair_path = os.path.join(
            "testdata",
            "headbonechainhairstyle",
            "test_hair_bone_chain_head_style.tfxhair",
        )
        hair_asset = Asset.find_asset_by_path(hair_path)
        actor_component.set_component_property_value(
            AtomComponentProperties.actor("Actor asset"), head_asset.id
        )
        hair_component.set_component_property_value(
            AtomComponentProperties.hair("Hair Asset"), hair_asset.id
        )
        Report.result(
            Tests.hair_asset,
            hair_component.get_component_property_value(
                AtomComponentProperties.hair("Hair Asset")
            )
            == hair_asset.id,
        )

        # 9. Set 'Base Albedo Asset' "testdata", "test_hair_skin_basecolor.png.streamingimage"
        base_albedo_path = os.path.join(
            "testdata", "test_hair_skin_basecolor.png.streamingimage"
        )
        ...
        Report.result(
            ...
            hair_component.get_component_property_value(
                AtomComponentProperties.hair("Base Albedo Asset")
            )
            == base_albede_asset.id,
        )
        ...
        Report.result(
            ...
            hair_component.get_component_property_value(
                AtomComponentProperties.hair("Strand Albedo Asset")
            )
            == strand_asset.id,
        )
        ...
        # 11. Toggle 'Enable Area Lights'
        hair_component.set_component_property_value(
            AtomComponentProperties.hair("Enable Area Lights"), False
        )
        Report.result(
            Tests.enable_area_lights,
            hair_component.get_component_property_value(
                AtomComponentProperties.hair("Enable Area Lights")
            )
            is False,
        )

        hair_component.set_component_property_value(
            AtomComponentProperties.hair("Enable Area Lights"), True
        )
        Report.result(
            Tests.enable_area_lights,
            hair_component.get_component_property_value(
        ...
        # 12. Toggle 'Enable Azimuth'
        hair_component.set_component_property_value(
            AtomComponentProperties.hair("Enable Azimuth"), False
        )
        Report.result(
            Tests.enable_azimuth,
            hair_component.get_component_property_value(
                AtomComponentProperties.hair("Enable Azimuth")
            )
            is False,
        )

        hair_component.set_component_property_value(
            AtomComponentProperties.hair("Enable Azimuth"), True
        )
        Report.result(
            Tests.enable_azimuth,
            hair_component.get_component_property_value(
        ...
        # 13. Toggle 'Enable Directional Lights'
        hair_component.set_component_property_value(
            AtomComponentProperties.hair("Enable Directional Lights"), False
        )
        Report.result(
            Tests.enable_directional_lights,
            hair_component.get_component_property_value(
                AtomComponentProperties.hair("Enable Directional Lights")
            )
            is False,
        )

        hair_component.set_component_property_value(
            AtomComponentProperties.hair("Enable Directional Lights"), True
        )
        Report.result(
            Tests.enable_directional_lights,
            hair_component.get_component_property_value(
        ...
        # 14. Toggle 'Enable IBL'
        hair_component.set_component_property_value(
            AtomComponentProperties.hair("Enable IBL"), False
        )
        Report.result(
            Tests.enable_ibl,
            hair_component.get_component_property_value(
                AtomComponentProperties.hair("Enable IBL")
            )
            is False,
        )

        hair_component.set_component_property_value(
            AtomComponentProperties.hair("Enable IBL"), True
        )
        Report.result(
            Tests.enable_ibl,
            hair_component.get_component_property_value(
        ...
        # 15. Toggle 'Enable Longitude'
        hair_component.set_component_property_value(
            AtomComponentProperties.hair("Enable Longitude"), False
        )
        Report.result(
            Tests.enable_longitude,
            hair_component.get_component_property_value(
                AtomComponentProperties.hair("Enable Longitude")
            )
            is False,
        )

        hair_component.set_component_property_value(
            AtomComponentProperties.hair("Enable Longitude"), True
        )
        Report.result(
            Tests.enable_longitude,
            hair_component.get_component_property_value(
        ...
        # 16. Toggle 'Enable Marschner R'
        hair_component.set_component_property_value(
            AtomComponentProperties.hair("Enable Marschner R"), False
        )
        Report.result(
            Tests.enable_marschner_r,
            hair_component.get_component_property_value(
                AtomComponentProperties.hair("Enable Marschner R")
            )
            is False,
        )

        hair_component.set_component_property_value(
            AtomComponentProperties.hair("Enable Marschner R"), True
        )
        Report.result(
            Tests.enable_marschner_r,
            hair_component.get_component_property_value(
        ...
        # 17. Toggle 'Enable Marschner TRT'
        hair_component.set_component_property_value(
            AtomComponentProperties.hair("Enable Marschner TRT"), False
        )
        Report.result(
            Tests.enable_marschner_trt,
            hair_component.get_component_property_value(
                AtomComponentProperties.hair("Enable Marschner TRT")
            )
            is False,
        )

        hair_component.set_component_property_value(
            AtomComponentProperties.hair("Enable Marschner TRT"), True
        )
        Report.result(
            Tests.enable_marschner_trt,
            hair_component.get_component_property_value(
        ...
        # 18. Toggle 'Enable Marschner TT'
        hair_component.set_component_property_value(
            AtomComponentProperties.hair("Enable Marschner TT"), False
        )
        Report.result(
            Tests.enable_marschner_tt,
            hair_component.get_component_property_value(
                AtomComponentProperties.hair("Enable Marschner TT")
            )
            is False,
        )

        hair_component.set_component_property_value(
            AtomComponentProperties.hair("Enable Marschner TT"), True
        )
        Report.result(
            Tests.enable_marschner_tt,
            hair_component.get_component_property_value(
        ...
        # 19. Toggle 'Enable Punctual Lights'
        hair_component.set_component_property_value(
            AtomComponentProperties.hair("Enable Punctual Lights"), False
        )
        Report.result(
            Tests.enable_punctual_lights,
            hair_component.get_component_property_value(
                AtomComponentProperties.hair("Enable Punctual Lights")
            )
            is False,
        )

        hair_component.set_component_property_value(
            AtomComponentProperties.hair("Enable Punctual Lights"), True
        )
        Report.result(
            Tests.enable_punctual_lights,
            hair_component.get_component_property_value(
        ...
        # 20. Toggle 'Enable Shadows'
        hair_component.set_component_property_value(
            AtomComponentProperties.hair("Enable Shadows"), False
        )
        Report.result(
            Tests.enable_shadows,
            hair_component.get_component_property_value(
                AtomComponentProperties.hair("Enable Shadows")
            )
            is False,
        )

        hair_component.set_component_property_value(
            AtomComponentProperties.hair("Enable Shadows"), True
        )
        Report.result(
            Tests.enable_shadows,
            hair_component.get_component_property_value(
        ...
        # 21. Toggle 'Enable Hair LOD'
        hair_component.set_component_property_value(
            AtomComponentProperties.hair("Enable Hair LOD"), True
        )
        Report.result(
            Tests.enable_hair_lod,
            hair_component.get_component_property_value(
                AtomComponentProperties.hair("Enable Hair LOD")
            )
            is True,
        )

        hair_component.set_component_property_value(
            AtomComponentProperties.hair("Enable Hair LOD"), False
        )
        Report.result(
            Tests.enable_hair_lod,
            hair_component.get_component_property_value(
        ...
        # 22. Toggle 'Enable Hair LOD(Shadow)'
        hair_component.set_component_property_value(
            AtomComponentProperties.hair("Enable Hair LOD(Shadow)"), True
        )
        Report.result(
            Tests.enable_hair_lod_shadow,
            hair_component.get_component_property_value(
                AtomComponentProperties.hair("Enable Hair LOD(Shadow)")
            )
            is True,
        )

        hair_component.set_component_property_value(
            AtomComponentProperties.hair("Enable Hair LOD(Shadow)"), False
        )
        Report.result(
            Tests.enable_hair_lod_shadow,
            hair_component.get_component_property_value(
        ...
        # 23. Toggle 'Enable Strand Tangent'
        hair_component.set_component_property_value(
            AtomComponentProperties.hair("Enable Strand Tangent"), True
        )
        Report.result(
            Tests.enable_strand_tangent,
            hair_component.get_component_property_value(
                AtomComponentProperties.hair("Enable Strand Tangent")
            )
            is True,
        )

        hair_component.set_component_property_value(
            AtomComponentProperties.hair("Enable Strand Tangent"), False
        )
        Report.result(
            Tests.enable_strand_tangent,
            hair_component.get_component_property_value(
        ...
        # 24. Toggle 'Enable Strand UV'
        hair_component.set_component_property_value(
            AtomComponentProperties.hair("Enable Strand UV"), True
        )
        Report.result(
            Tests.enable_strand_uv,
            hair_component.get_component_property_value(
                AtomComponentProperties.hair("Enable Strand UV")
            )
            is True,
        )

        hair_component.set_component_property_value(
            AtomComponentProperties.hair("Enable Strand UV"), False
        )
        Report.result(
            Tests.enable_strand_uv,
            hair_component.get_component_property_value(
        ...
        # 25. Toggle 'Enable Thin Tip'
        hair_component.set_component_property_value(
            AtomComponentProperties.hair("Enable Thin Tip"), False
        )
        Report.result(
            Tests.enable_thin_tip,
            hair_component.get_component_property_value(
                AtomComponentProperties.hair("Enable Thin Tip")
            )
            is False,
        )

        hair_component.set_component_property_value(
            AtomComponentProperties.hair("Enable Thin Tip"), True
        )
        Report.result(
            Tests.enable_thin_tip,
            hair_component.get_component_property_value(
        ...
        for model in HAIR_LIGHTING_MODEL:
            hair_component.set_component_property_value(
                AtomComponentProperties.hair("Hair Lighting Model"),
                HAIR_LIGHTING_MODEL[model],
            )
        ...
        Report.result(
            Tests.base_color,
            hair_component.get_component_property_value(
                AtomComponentProperties.hair("Base Color")
            )
            == red,
        )
        ...
        Report.result(
            ...
            Math_IsClose(
                hair_component.get_component_property_value(
                    AtomComponentProperties.hair("Fiber Radius")
                ),
                0.009,
            ),
        )
        ...
        Report.result(
            ...
            Math_IsClose(
                hair_component.get_component_property_value(
                    AtomComponentProperties.hair("Fiber Spacing")
                ),
                0.9,
            ),
        )
        ...
        Report.result(
            ...
            Math_IsClose(
                hair_component.get_component_property_value(
                    AtomComponentProperties.hair("Fiber ratio")
                ),
                0.09,
            ),
        )
        ...
        Report.result(
            ...
            Math_IsClose(
                hair_component.get_component_property_value(
                    AtomComponentProperties.hair("Hair Cuticle Angle")
                ),
                0.9,
            ),
        )
        ...
        Report.result(
            ...
            Math_IsClose(
                hair_component.get_component_property_value(
                    AtomComponentProperties.hair("Hair Ex1")
                ),
                99.0,
            ),
        )
        ...
        Report.result(
            ...
            Math_IsClose(
                hair_component.get_component_property_value(
                    AtomComponentProperties.hair("Hair Ex2")
                ),
                100.0,
            ),
        )
        ...
        Report.result(
            ...
            Math_IsClose(
                hair_component.get_component_property_value(
                    AtomComponentProperties.hair("Hair Kdiffuse")
                ),
                0.9,
            ),
        )
        ...
        Report.result(
            ...
            Math_IsClose(
                hair_component.get_component_property_value(
                    AtomComponentProperties.hair("Hair Ks1")
                ),
                0.009,
            ),
        )
        ...
        Report.result(
            ...
            Math_IsClose(
                hair_component.get_component_property_value(
                    AtomComponentProperties.hair("Hair Ks2")
                ),
                0.199,
            ),
        )
        ...
        Report.result(
            ...
            Math_IsClose(
                hair_component.get_component_property_value(
                    AtomComponentProperties.hair("Hair Roughness")
                ),
                0.9,
            ),
        )
        ...
        Report.result(
            ...
            Math_IsClose(
                hair_component.get_component_property_value(
                    AtomComponentProperties.hair("Hair Shadow Alpha")
                ),
                0.6,
            ),
        )
        ...
        Report.result(
            ...
            Math_IsClose(
                hair_component.get_component_property_value(
                    AtomComponentProperties.hair("LOD End Distance")
                ),
                9.0,
            ),
        )
        ...
        Report.result(
            ...
            Math_IsClose(
                hair_component.get_component_property_value(
                    AtomComponentProperties.hair("LOD Start Distance")
                ),
                0.9,
            ),
        )
        ...
        Report.result(
            Tests.mat_tip_color,
            hair_component.get_component_property_value(
                AtomComponentProperties.hair("Mat Tip Color")
            )
            == blue,
        )
        ...
        Report.result(
            ...
            Math_IsClose(
                hair_component.get_component_property_value(
                    AtomComponentProperties.hair("Max LOD Reduction")
                ),
                0.6,
            ),
        )
        ...
        Report.result(
            ...
            Math_IsClose(
                hair_component.get_component_property_value(
                    AtomComponentProperties.hair("Max LOD Strand Width Multiplier")
                ),
                6.0,
            ),
        )
        ...
        Report.result(
            ...
            hair_component.get_component_property_value(
                AtomComponentProperties.hair("Max Shadow Fibers")
            )
            == 100,
        )
        ...
        Report.result(
            ...
            Math_IsClose(
                hair_component.get_component_property_value(
                    AtomComponentProperties.hair("Shadow LOD End Distance")
                ),
                6.0,
            ),
        )
        ...
        Report.result(
            ...
            Math_IsClose(
                hair_component.get_component_property_value(
                    AtomComponentProperties.hair("Shadow LOD Start Distance")
                ),
                0.6,
            ),
        )
        ...
        Report.result(
            ...
            Math_IsClose(
                hair_component.get_component_property_value(
                    AtomComponentProperties.hair("Shadow Max LOD Reduction")
                ),
                0.9,
            ),
        )
        ...
        Report.result(
            ...
            Math_IsClose(
                hair_component.get_component_property_value(
                    AtomComponentProperties.hair("Strand UVTiling Factor")
                ),
                9.0,
            ),
        )
        ...
        Report.result(
            ...
            Math_IsClose(
                hair_component.get_component_property_value(
                    AtomComponentProperties.hair("Tip Percentage")
                ),
                0.6,
            ),
        )
        ...
        Report.result(
            ...
            Math_IsClose(
                hair_component.get_component_property_value(
                    AtomComponentProperties.hair("Clamp Velocity")
                ),
                1.0,
            ),
        )
        ...
        Report.result(
            ...
            Math_IsClose(
                hair_component.get_component_property_value(
                    AtomComponentProperties.hair("Damping")
                ),
                0.6,
            ),
        )
        ...
        Report.result(
            ...
            Math_IsClose(
                hair_component.get_component_property_value(
                    AtomComponentProperties.hair("Global Constraint Range")
                ),
                0.999,
            ),
        )
        ...
        Report.result(
            ...
            Math_IsClose(
                hair_component.get_component_property_value(
                    AtomComponentProperties.hair("Global Constraint Stiffness")
                ),
                0.666,
            ),
        )
        ...
        Report.result(
            ...
            Math_IsClose(
                hair_component.get_component_property_value(
                    AtomComponentProperties.hair("Gravity Magnitude")
                ),
                0.66,
            ),
        )
        ...
        Report.result(
            ...
            hair_component.get_component_property_value(
                AtomComponentProperties.hair("Length Constraint Iterations")
            )
            == 9,
        )
        ...
        Report.result(
            ...
            hair_component.get_component_property_value(
                AtomComponentProperties.hair("Local Constraint Iterations")
            )
            == 1,
        )
        ...
        Report.result(
            ...
            Math_IsClose(
                hair_component.get_component_property_value(
                    AtomComponentProperties.hair("Local Constraint Stiffness")
                ),
                0.999,
            ),
        )
        ...
        Report.result(
            ...
            Math_IsClose(
                hair_component.get_component_property_value(
                    AtomComponentProperties.hair("Tip Separation")
                ),
                0.6,
            ),
        )
        ...
        Report.result(
            ...
            Math_IsClose(
                hair_component.get_component_property_value(
                    AtomComponentProperties.hair("Vsp Accel Threshold")
                ),
                10.0,
            ),
        )
        ...
        Report.result(
            ...
            Math_IsClose(
                hair_component.get_component_property_value(
                    AtomComponentProperties.hair("Vsp Coeffs")
                ),
                0.999,
            ),
        )
        ...
        Report.result(
            ...
            Math_IsClose(
                hair_component.get_component_property_value(
                    AtomComponentProperties.hair("Wind Angle Radians")
                ),
                0.999,
            ),
        )
        ...
        Report.result(
            ...
            hair_component.get_component_property_value(
                AtomComponentProperties.hair("Wind Direction")
            )
            == x_direction,
        )
        ...
        Report.result(
            ...
            Math_IsClose(
                hair_component.get_component_property_value(
                    AtomComponentProperties.hair("Wind Magnitude")
                ),
                1.0,
            ),
        )
