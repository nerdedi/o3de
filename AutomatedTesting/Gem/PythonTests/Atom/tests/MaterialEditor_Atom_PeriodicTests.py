...
def MaterialEditor_FileSaveChecks_AllChecksPass():
    ...
    with Tracer() as error_tracer:
        ...
        original_material_document = os.path.join(
            atom_tools_utils.TEST_DATA_MATERIALS_PATH,
        ...
        # 1. Open an existing material document referred to as "original_material_document".
        original_material_document_id = atom_tools_utils.open_document(
            original_material_document
        )
        Report.result(
        ...
        Report.result(
            ...
            == expected_original_material_starting_color,
        )

        # 3. Change the baseColor.color property value of original_material_document to 0.25, 0.25, 0.25, 1.0.
        original_material_document_color = Color(0.25, 0.25, 0.25, 1.0)
        material_editor_utils.set_property(
            original_material_document_id,
            base_color_property_name,
            original_material_document_color,
        )
        Report.result(
        ...
        # 4. Save over original_material_document.
        original_material_document_saved = atom_tools_utils.save_document(
            original_material_document_id
        )
        Report.result(
        ...
        Report.result(
            Tests.saved_new_material_document, new_material_document_saved is True
        )
        ...
        Report.result(
            Tests.saved_child_material_document, child_material_document_saved is True
        )
        ...
        child_material_document_id = atom_tools_utils.open_document(
            child_material_document
        )
        ...
        ) in material_document_ids.items():
            Report.result(
                (
        ...
        Report.result(
            ...
            material_editor_utils.get_property(
                new_material_document_id, base_color_property_name
            )
            == new_material_document_color,
        )
        ...
        Report.result(
            ...
            material_editor_utils.get_property(
                child_material_document_id, base_color_property_name
            )
            == child_material_document_color,
        )
        ...
        original_document_saved = atom_tools_utils.save_document(
            original_material_document_id
        )
        Report.result(
            Tests.resaved_original_material_document, original_document_saved is True
        )
        Report.result(
        ...
        # 15. Open a material document referred to as "first_material_document".
        first_material_document_id = atom_tools_utils.open_document(
            first_material_document
        )
        Report.result(
        ...
        Report.result(
            ...
            == expected_first_material_starting_color,
        )
        ...
        Report.result(
            Tests.saved_first_material_document, first_material_document_saved is True
        )

        # 19. Open a second material document referred to as "second_material_document".
        second_material_document_id = atom_tools_utils.open_document(
            second_material_document
        )
        Report.result(
        ...
        # 20. Verify second_material_document baseColor.color property value
        # is 0.5093766450881958, 0.5093766450881958, 0.5093766450881958, 1.0.
        expected_second_material_starting_color = Color(
            0.5093766450881958, 0.5093766450881958, 0.5093766450881958, 1.0
        )
        Report.result(
            ...
            == expected_second_material_starting_color,
        )
        ...
        material_editor_utils.set_property(
            ...
            base_color_property_name,
            second_material_document_color,
        )
        Report.result(
        ...
        Report.result(
            Tests.saved_second_material_document, second_material_document_saved is True
        )

        # 23. Close the first_material_document and second_material_document.
        first_material_document_closed = atom_tools_utils.close_document(
            first_material_document_id
        )
        Report.result(
            Tests.closed_first_material_document, first_material_document_closed is True
        )
        Report.result(
            Tests.first_material_document_is_not_open,
            atom_tools_utils.is_document_open(first_material_document_id) is False,
        )
        second_material_document_closed = atom_tools_utils.close_document(
            second_material_document_id
        )
        Report.result(
        ...
        # 27. Re-save first_material_document and second_material_document to restore their original values.
        first_material_document_resaved = atom_tools_utils.save_document(
            first_material_document_id
        )
        Report.result(
        ...
        second_material_document_resaved = atom_tools_utils.save_document(
            second_material_document_id
        )
        Report.result(
