...
class TestAutomation(EditorTestSuite):
    ...
    @pytest.mark.skip(
        reason="These are old GPU tests that are going to be changed in a future update."
    )
    class AtomGPU_LightComponent_AreaLightScreenshotsMatchGoldenImages_DX12(
        EditorSingleTest
    ):
    ...
    class AtomGPU_LightComponent_AreaLightScreenshotsMatchGoldenImages_Vulkan(
        EditorSingleTest
    ):
        from Atom.tests import hydra_AtomGPU_AreaLightScreenshotTest as test_module
    ...
    class AtomGPU_LightComponent_SpotLightScreenshotsMatchGoldenImages_DX12(
        EditorSingleTest
    ):
    ...
    class AtomGPU_LightComponent_SpotLightScreenshotsMatchGoldenImages_Vulkan(
        EditorSingleTest
    ):
        from Atom.tests import hydra_AtomGPU_SpotLightScreenshotTest as test_module
    ...
    class AtomEditorComponents_HDRColorGrading_Generate_Activate_LUT(EditorBatchedTest):
        from Atom.tests import (
            periodic_AtomEditorComponents_HDRColorGradingAdded as test_module,
        )
