...
def PhysX_Primitive_Collider_Component_CRUD():
    ...
    from editor_python_test_tools.editor_component.editor_physx_primitive_collider import (
        EditorPhysxPrimitiveCollider as PhysxPrimitiveCollider,
    )
    ...
    from editor_python_test_tools.editor_component.editor_component_validation import (
        validate_property_switch_toggle,
        validate_vector3_property,
    ...
    with Tracer():
        ...
        validate_vector3_property(
            "Box Dimensions",
            physx_collider.get_box_dimensions,
            physx_collider.set_box_dimensions,
        ...
        validate_float_property(
            "Capsule Height",
            physx_collider.get_capsule_height,
            physx_collider.set_capsule_height,
            PHYSX_PRIMITIVE_COLLIDER,
            FLOAT_HEIGHT_TESTS,
        )
        validate_float_property(
            "Capsule Radius",
            physx_collider.get_capsule_radius,
            physx_collider.set_capsule_radius,
            physx_collider.component.get_component_name(),
            COLLIDER_RADIUS_TESTS,
        )
        ...
        validate_float_property(
            "Cylinder Height",
            physx_collider.get_cylinder_height,
            physx_collider.set_cylinder_height,
            PHYSX_PRIMITIVE_COLLIDER,
            CYLINDER_HEIGHT_TESTS,
        )
        validate_float_property(
            "Cylinder Radius",
            physx_collider.get_cylinder_radius,
            physx_collider.set_cylinder_radius,
            PHYSX_PRIMITIVE_COLLIDER,
            COLLIDER_RADIUS_TESTS,
        )
        ...
        validate_integer_property(
            ...
            physx_collider.get_cylinder_subdivision,
            physx_collider.set_cylinder_subdivision,
            PHYSX_PRIMITIVE_COLLIDER,
            CYLINDER_SUBDIVISION_TESTS,
        )
        ...
        validate_float_property(
            "Sphere Radius",
            physx_collider.get_sphere_radius,
            physx_collider.set_sphere_radius,
            PHYSX_PRIMITIVE_COLLIDER,
            COLLIDER_RADIUS_TESTS,
        )
        ...
        validate_property_switch_toggle(
            "Is Trigger",
            physx_collider.get_is_trigger,
            physx_collider.set_is_trigger,
            PHYSX_PRIMITIVE_COLLIDER,
        )
        validate_property_switch_toggle(
            "Is Simulated",
            physx_collider.get_is_simulated,
            physx_collider.set_is_simulated,
            PHYSX_PRIMITIVE_COLLIDER,
        )
        validate_property_switch_toggle(
            "In Scene Queries",
            physx_collider.get_in_scene_queries,
            physx_collider.set_in_scene_queries,
            PHYSX_PRIMITIVE_COLLIDER,
        )

        validate_vector3_property(
            "Offset",
            physx_collider.get_offset,
            physx_collider.set_offset,
            PHYSX_PRIMITIVE_COLLIDER,
            VECTOR3_TESTS_NEGATIVE_EXPECT_PASS,
        )
        ...
        validate_float_property(
            "Contact Offset",
            physx_collider.get_contact_offset,
            physx_collider.set_contact_offset,
            PHYSX_PRIMITIVE_COLLIDER,
            CONTACT_OFFSET_TESTS,
        )
        validate_float_property(
            "Rest Offset",
            physx_collider.get_rest_offset,
            physx_collider.set_rest_offset,
            PHYSX_PRIMITIVE_COLLIDER,
            REST_OFFSET_TESTS,
        )
        ...
        validate_property_switch_toggle(
            "Draw Collider",
            physx_collider.get_draw_collider,
            physx_collider.set_draw_collider,
            PHYSX_PRIMITIVE_COLLIDER,
        )
