...
def PhysX_Mesh_Collider_Component_CRUD():
    ...
    from editor_python_test_tools.editor_component.editor_physx_mesh_collider import (
        EditorPhysxMeshCollider as PhysxMeshCollider,
    )
    ...
    with Tracer():
        ...
        validate_asset_property(
            "PhysX Mesh Asset",
            physx_collider.get_physx_mesh,
            physx_collider.set_physx_mesh,
            PHYSX_MESH_COLLIDER,
            physx_mesh,
        )
        validate_vector3_property(
            "PhysX Mesh Asset Scale",
            physx_collider.get_physx_mesh_asset_scale,
            physx_collider.set_physx_mesh_asset_scale,
            PHYSX_MESH_COLLIDER,
            VECTOR3_TESTS_NEGATIVE_EXPECT_PASS,
        )
        validate_property_switch_toggle(
            "Use Physics Materials From Asset",
            physx_collider.get_use_physics_materials_from_asset,
            physx_collider.set_use_physics_materials_from_asset,
            PHYSX_MESH_COLLIDER,
        )
