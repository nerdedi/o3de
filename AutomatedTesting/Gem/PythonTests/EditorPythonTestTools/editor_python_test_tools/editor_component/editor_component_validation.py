...
def compare_vec3(expected: Math.Vector3, actual: Math.Vector3) -> bool:
    ...
    """
    x_is_close = Math.Math_IsClose(
        expected.get_property("x"), actual.get_property("x"), 0.01
    )
    y_is_close = Math.Math_IsClose(
        expected.get_property("y"), actual.get_property("y"), 0.01
    )
    z_is_close = Math.Math_IsClose(
        expected.get_property("z"), actual.get_property("z"), 0.01
    )
...
def _validate_property_visibility(
    component: EditorComponent, component_property_path: str, expected: str
) -> None:
    """
    ...
    """
    Report.info(
        f"Validating visibility for {component.get_component_name()} "
...
def validate_integer_property(
    property_name: str,
    get_int_value: typing.Callable,
    set_int_value: typing.Callable,
    component_name: str,
    tests: typing.Dict[str, typing.Tuple[int, bool]],
) -> None:
    """
    ...
    """
    Report.info(
        f"Validating {component_name}'s {property_name} Integer property can be set or fails gracefully."
    )
...
def validate_float_property(
    property_name: str,
    get_float_value: typing.Callable,
    set_float_value: typing.Callable,
    component_name: str,
    tests: typing.Dict[str, typing.Tuple[float, bool]],
) -> None:
    """
    ...
    """
    Report.info(
        f"Validating {component_name}'s {property_name} Float property can be set or fails gracefully."
    )
...
def validate_vector3_property(
    property_name: str,
    get_vector3_value: typing.Callable,
    set_vector3_value: typing.Callable,
    component_name: str,
    tests: typing.Dict[str, typing.Tuple[float, float, float, bool]],
) -> None:
    """
    ...
    """
    Report.info(
        f"Validating {component_name}'s {property_name} Vector3 property can be set or fails gracefully."
    )
...
def validate_property_switch_toggle(
    property_name: str,
    get_toggle_value: typing.Callable,
    set_toggle_value: typing.Callable,
    component_name: str,
    ...
    """
    Report.info(
        f"Validating {component_name}'s {property_name} property toggle switch toggles."
    )
...
def validate_asset_property(
    property_name: str,
    get_asset_value: typing.Callable,
    set_asset_value: typing.Callable,
    component_name: str,
    asset_path: str,
) -> None:
    """
    ...
    """
    Report.info(
        f"Validating {component_name}'s {property_name} Asset property can be set."
    )
...
def validate_script_canvas_graph_file(
    get_script_canvas_graph_file: typing.Callable,
    set_script_canvas_graph_file: typing.Callable,
    sc_file_path: str,
) -> None:
    """
    ...
    assert (set_value != old_value) and set_value is not None, (
        "Graph file could not be set!"
    )


def validate_script_canvas_variable_changed(
    get_variable_value: typing.Callable,
    set_variable_value: typing.Callable,
    variable_name: str,
    variable_state: VariableState,
    expected_variable_value: Any,
) -> None:
    """
    ...
    """
    Report.info(
        "Validating Script Canvas component's variable can be set. This will seek out the variable in the "
    ...
    assert expected_variable_value == new_variable_value, (
        f"Component variable {variable_name} was not set properly. "
