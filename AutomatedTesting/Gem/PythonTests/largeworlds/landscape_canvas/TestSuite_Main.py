...
class TestAutomation(EditorTestSuite):
    ...
    class test_LandscapeCanvas_GradientModifierNodes_EntityCreatedOnNodeAdd(
        EditorBatchedTest
    ):
        from .EditorScripts import (
            GradientModifierNodes_EntityCreatedOnNodeAdd as test_module,
        )

    class test_LandscapeCanvas_GradientModifierNodes_EntityRemovedOnNodeDelete(
        EditorBatchedTest
    ):
        from .EditorScripts import (
            GradientModifierNodes_EntityRemovedOnNodeDelete as test_module,
        )

    class test_LandscapeCanvas_GradientNodes_DependentComponentsAdded(
        EditorBatchedTest
    ):
    ...
    class test_LandscapeCanvas_GradientNodes_EntityRemovedOnNodeDelete(
        EditorBatchedTest
    ):
        from .EditorScripts import (
            GradientNodes_EntityRemovedOnNodeDelete as test_module,
        )
    ...
    class test_LandscapeCanvas_GraphClosed_TabbedGraphClosesIndependently(
        EditorBatchedTest
    ):
    ...
    class test_LandscapeCanvas_LayerExtenderNodes_ComponentEntitySync(
        EditorBatchedTest
    ):
    ...
    class test_LandscapeCanvas_SlotConnections_UpdateComponentReferences(
        ...
        from .EditorScripts import (
            SlotConnections_UpdateComponentReferences as test_module,
        )

    class test_LandscapeCanvas_ExistingTerrainSetups_GraphSuccessfully(
        EditorBatchedTest
    ):
        from .EditorScripts import (
            Terrain_ExistingSetups_GraphSuccessfully as test_module,
        )
    ...
    class test_LandscapeCanvas_TerrainExtenderNodes_ComponentEntitySync(
        EditorBatchedTest
    ):
        from .EditorScripts import (
            TerrainExtenderNodes_ComponentEntitySync as test_module,
        )
    ...
    class test_LandscapeCanvas_TerrainNodes_EntityRemovedOnNodeDelete(
        EditorBatchedTest
    ):
