...
class TestAutomation(EditorTestSuite):
    ...
    class test_AltitudeFilter_Component(EditorBatchedTest):
        from .EditorScripts import (
            AltitudeFilter_ComponentAndOverrides_InstancesPlantAtSpecifiedAltitude as test_module,
        )
    ...
    class test_AltitudeFilter_Shape(EditorBatchedTest):
        from .EditorScripts import (
            AltitudeFilter_ShapeSample_InstancesPlantAtSpecifiedAltitude as test_module,
        )

    class test_AssetListCombiner(EditorBatchedTest):
        from .EditorScripts import (
            AssetListCombiner_CombinedDescriptorsExpressInConfiguredArea as test_module,
        )

    class test_AssetWeightSelector(EditorBatchedTest):
        from .EditorScripts import (
            AssetWeightSelector_InstancesExpressBasedOnWeight as test_module,
        )
    ...
    class test_DistanceBetweenFilter_InstancesPlantAtSpecifiedRadius(EditorBatchedTest):
        from .EditorScripts import (
            DistanceBetweenFilter_InstancesPlantAtSpecifiedRadius as test_module,
        )

    @pytest.mark.skip(reason="https://github.com/o3de/o3de/issues/4155")
    class test_DistanceBetweenFilterOverrides_InstancesPlantAtSpecifiedRadius(
        EditorBatchedTest
    ):
        from .EditorScripts import (
            DistanceBetweenFilterOverrides_InstancesPlantAtSpecifiedRadius as test_module,
        )
    ...
    class test_InstanceSpawnerPriority(EditorBatchedTest):
        from .EditorScripts import (
            InstanceSpawnerPriority_LayerAndSubPriority as test_module,
        )
    ...
    class test_LayerBlocker(EditorBatchedTest):
        from .EditorScripts import (
            LayerBlocker_InstancesBlockedInConfiguredArea as test_module,
        )
    ...
    class test_LayerSpawner_Plant(EditorBatchedTest):
        from .EditorScripts import (
            LayerSpawner_InstancesPlantInAllSupportedShapes as test_module,
        )

    @pytest.mark.xfail(reason="https://github.com/o3de/o3de/issues/6549")
    class test_LayerSpawner_InstancesRefreshUsingCorrectViewportCamera(
        EditorBatchedTest
    ):
        from .EditorScripts import (
            LayerSpawner_InstancesRefreshUsingCorrectViewportCamera as test_module,
        )
    ...
    class test_MeshBlocker_Height(EditorBatchedTest):
        from .EditorScripts import (
            MeshBlocker_InstancesBlockedByMeshHeightTuning as test_module,
        )

    class test_MeshSurfaceTagEmitter_Mesh(EditorBatchedTest):
        from .EditorScripts import (
            MeshSurfaceTagEmitter_DependentOnMeshComponent as test_module,
        )

    class test_MeshSurfaceTagEmitter_Tags(EditorBatchedTest):
        from .EditorScripts import (
            MeshSurfaceTagEmitter_SurfaceTagsAddRemoveSuccessfully as test_module,
        )

    class test_SurfaceTagEmitter(EditorBatchedTest):
        from .EditorScripts import (
            PhysXColliderSurfaceTagEmitter_E2E_Editor as test_module,
        )

    @pytest.mark.skip(reason="https://github.com/o3de/o3de/issues/17337")
    class test_PositionModifier_Snap(EditorBatchedTest):
        from .EditorScripts import (
            PositionModifier_AutoSnapToSurfaceWorks as test_module,
        )
    ...
    class test_RotationModifier(EditorBatchedTest):
        from .EditorScripts import (
            RotationModifier_InstancesRotateWithinRange as test_module,
        )

    class test_RotationModifierOverrides(EditorBatchedTest):
        from .EditorScripts import (
            RotationModifierOverrides_InstancesRotateWithinRange as test_module,
        )
    ...
    class test_ScaleModifierOverrides(EditorBatchedTest):
        from .EditorScripts import (
            ScaleModifierOverrides_InstancesProperlyScale as test_module,
        )

    class test_ShapeFilter_Toggle(EditorBatchedTest):
        from .EditorScripts import (
            ShapeIntersectionFilter_FilterStageToggle as test_module,
        )

    class test_ShapeFilter_Plant(EditorBatchedTest):
        from .EditorScripts import (
            ShapeIntersectionFilter_InstancesPlantInAssignedShape as test_module,
        )

    class test_SlopeAlignmentModifier(EditorBatchedTest):
        from .EditorScripts import (
            SlopeAlignmentModifier_InstanceSurfaceAlignment as test_module,
        )

    class test_SlopeAlignmentModifierOverrides(EditorBatchedTest):
        from .EditorScripts import (
            SlopeAlignmentModifierOverrides_InstanceSurfaceAlignment as test_module,
        )

    @pytest.mark.skip(reason="https://github.com/o3de/o3de/issues/17337")
    class test_SlopeFilter_Plant(EditorBatchedTest):
        from .EditorScripts import (
            SlopeFilter_ComponentAndOverrides_InstancesPlantOnValidSlope as test_module,
        )

    class test_SpawnerPrefabs_Toggle(EditorBatchedTest):
        from .EditorScripts import (
            SpawnerPrefabs_PrefabCreationAndVisibilityToggleWorks as test_module,
        )
    ...
    class test_SurfaceMaskFilter_BasicTag(EditorBatchedTest):
        from .EditorScripts import (
            SurfaceMaskFilter_BasicSurfaceTagCreation as test_module,
        )
    ...
    class test_SurfaceMaskFilterOverrides(EditorBatchedTest):
        from .EditorScripts import (
            SurfaceMaskFilterOverrides_MultipleDescriptorOverridesPlantAsExpected as test_module,
        )
    ...
    class test_VegetationInstances_DespawnWhenOutOfRange(EditorBatchedTest):
        from .EditorScripts import (
            VegetationInstances_DespawnWhenOutOfRange as test_module,
        )
