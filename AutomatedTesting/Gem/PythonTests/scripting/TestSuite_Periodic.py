...
class TestScriptCanvas(EditorTestSuite):
    ...
    @pytest.mark.xfail(
        reason="keyboard shortcuts are not behaving properly: https://github.com/o3de/o3de/issues/14802"
    )
...
class TestAutomationQtPyTests(TestAutomationBase):
    ...
    def test_ScriptCanvas_ChangingAssets_ComponentStable(
    ...
    def test_VariableManager_UnpinVariableType_Works(
        self, request, workspace, editor, launcher_platform
    ):
    ...
    def test_ScriptCanvas_TwoComponents_InteractSuccessfully(
        self, request, workspace, editor, launcher_platform
    ):
    ...
    def test_ScriptCanvas_TwoEntities_UseSimultaneously(
        self, request, workspace, editor, launcher_platform
    ):
        from . import ScriptCanvas_TwoComponents_InteractSuccessfully as test_module
    ...
    def test_ScriptCanvasComponent_OnEntityActivatedDeactivated_PrintMessage(
        self, request, workspace, editor, launcher_platform
    ):
        from . import (
            ScriptCanvasComponent_OnEntityActivatedDeactivated_PrintMessage as test_module,
        )

        self._run_test(request, workspace, editor, test_module)

    def test_ScriptEvents_Default_SendReceiveSuccessfully(
        self, request, workspace, editor, launcher_platform
    ):
    ...
    def test_ScriptEvents_HappyPath_SendReceiveAcrossMultiple(
        self, request, workspace, editor, launcher_platform
    ):
    ...
    def test_ScriptEvents_ReturnSetType_Successfully(
        self, request, workspace, editor, launcher_platform
    ):
    ...
    @pytest.mark.skip(
        reason="a Qt checkbox does not trigger: https://github.com/o3de/o3de/issues/14860"
    )
...
class TestAutomation(TestAutomationBase):
    def test_Pane_HappyPath_OpenCloseSuccessfully(
        self, request, workspace, editor, launcher_platform
    ):
    ...
    def test_Pane_HappyPath_DocksProperly(
        self, request, workspace, editor, launcher_platform
    ):
    ...
    def test_Pane_HappyPath_ResizesProperly(
        self, request, workspace, editor, launcher_platform
    ):
    ...
    def test_Graph_HappyPath_ZoomInZoomOut(
        self, request, workspace, editor, launcher_platform
    ):
    ...
    def test_NodePalette_HappyPath_ClearSelection(
    ...
    def test_ScriptCanvasTools_Toggle_OpenCloseSuccess(
        self, request, workspace, editor, launcher_platform
    ):
    ...
    def test_NodeInspector_HappyPath_VariableRenames(
        self, request, workspace, editor, launcher_platform, project
    ):
    ...
    def test_Debugger_HappyPath_TargetMultipleGraphs(
        self, request, workspace, editor, launcher_platform, project
    ):
    ...
    @pytest.mark.skip(
        reason="Test fails on nightly build builds, it needs to be fixed."
    )
    @pytest.mark.parametrize("level", ["tmp_level"])
    def test_Debugger_HappyPath_TargetMultipleEntities(
        self, request, workspace, editor, launcher_platform, project, level
    ):
        def teardown():
            file_system.delete(
                [os.path.join(workspace.paths.project(), "Levels", level)], True, True
            )
    ...
    def test_Pane_Undocked_ClosesSuccessfully(
        self, request, workspace, editor, launcher_platform
    ):
    ...
    @pytest.mark.parametrize("level", ["tmp_level"])
    def test_Entity_HappyPath_AddScriptCanvasComponent(
        self, request, workspace, editor, launcher_platform, project, level
    ):
        def teardown():
            file_system.delete(
    ...
    def test_Pane_Default_RetainOnSCRestart(
        self, request, workspace, editor, launcher_platform
    ):
...
class TestScriptCanvasTests(object):
    ...
    @pytest.mark.skipif(
        ly_test_tools.LINUX,
        reason="investigate and update https://github.com/o3de/o3de/issues/15553",
    )
