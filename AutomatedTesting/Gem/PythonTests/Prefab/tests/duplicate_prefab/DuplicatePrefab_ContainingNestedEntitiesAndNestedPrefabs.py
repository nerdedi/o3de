...
def DuplicatePrefab_ContainingNestedEntitiesAndNestedPrefabs():
    ...
    nested_entities_root_on_instance = new_prefab.get_direct_child_entity_by_name(
    ...
    common_parent_children_ids_after_duplicate_undo = set(
        [child_id.ToString() for child_id in common_parent.get_children_ids()]
    )
    assert (
        common_parent_children_ids_before_duplicate
        == common_parent_children_ids_after_duplicate_undo
