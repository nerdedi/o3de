...
class TestAutomationOverridesDisabled(EditorTestSuite):
    ...
    EditorTestSuite.global_extra_cmdline_args.extend(
        [
            "--regset=/O3DE/Autoexec/ConsoleCommands/ed_enableOutlinerOverrideManagement=false",
            "--regset=/O3DE/Autoexec/ConsoleCommands/ed_enableInspectorOverrideManagement=false",
            "--regset=/O3DE/Autoexec/ConsoleCommands/ed_enableDPEInspector=false",
        ]
    )
    ...
    class test_SC_Spawnables_DespawnOnEntityDeactivate(EditorBatchedTest):
        from .tests.spawnables import (
            SC_Spawnables_DespawnOnEntityDeactivate as test_module,
        )

    class test_SC_Spawnables_EntityClearedOnGameModeExit(EditorBatchedTest):
        from .tests.spawnables import (
            SC_Spawnables_EntityClearedOnGameModeExit as test_module,
        )

    class test_SC_Spawnables_MultipleSpawnsFromSingleTicket(EditorBatchedTest):
        from .tests.spawnables import (
            SC_Spawnables_MultipleSpawnsFromSingleTicket as test_module,
        )
    ...
    class test_Lua_Spawnables_DespawnOnEntityDeactivate(EditorBatchedTest):
        from .tests.spawnables import (
            Lua_Spawnables_DespawnOnEntityDeactivate as test_module,
        )

    class test_Lua_Spawnables_EntityClearedOnGameModeExit(EditorBatchedTest):
        from .tests.spawnables import (
            Lua_Spawnables_EntityClearedOnGameModeExit as test_module,
        )

    class test_Lua_Spawnables_MultipleSpawnsFromSingleTicket(EditorBatchedTest):
        from .tests.spawnables import (
            Lua_Spawnables_MultipleSpawnsFromSingleTicket as test_module,
        )
    ...
    class test_Lua_Spawnables_SimpleSpawnAndDespawn(EditorBatchedTest):
        from .tests.spawnables import (
            Lua_Spawnables_SimpleSpawnAndDespawn as test_module,
        )
...
class TestAutomationOverrides(EditorTestSuite):
    ...
    class test_AddEntity_UnderUnfocusedInstanceAsOverride(EditorBatchedTest):
        from .tests.overrides import (
            AddEntity_UnderUnfocusedInstanceAsOverride as test_module,
        )
