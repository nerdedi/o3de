...
def Scene_Settings_Clear_Unsaved_Changes():
    ...
    async def run_test():
        ...
        Report.critical_result(tm.Test_Messages.scene_settings_has_unsaved_changes, has_unsaved_changes)
        ...
        Report.critical_result(tm.Test_Messages.scene_settings_unsaved_changes_cleared, not has_unsaved_changes)
