...
def SubID_WarningReported_AssetRemoved():
    ...
    src = os.path.join(
        ...
        "Objects",
        "ShaderBall_simple",
        "shaderball_simple_NoMesh_NoID.fbx.assetinfo",
    )
    ...
    model_path = os.path.join(
        "objects", "shaderball_simple_phong_0_17699592688871882463.fbx.azmaterial"
    )
    ...
    warning = (
        "[AssetManager] GetAsset called for asset which does not exist in asset catalog and cannot be loaded. "
