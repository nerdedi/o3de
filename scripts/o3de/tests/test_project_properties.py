...
class TestEditProjectProperties:
    ...
    @pytest.mark.parametrize(
        "project_path, project_name, project_new_name, project_id, project_origin,\
        ...
        [
            pytest.param(
                ...
                ["GemA"],
                None,
                ["ExistingGemA", {"name": "ExistingGemB", "optional": True}, "GemB"],
                "NewEngineName",
                "o3de>=1.0",
                "o3de-sdk==2205.01",
                None,
                ...
                None,
                None,
                ["framework==1.2.3", "editor==2.3.4"],
                False,
                True,
                pathlib.Path("D:/TestEngine"),
                pathlib.Path("cmake/CustomEngineFinder.cmake"),
                0,
            ),
            ...
            pytest.param(
                ...
                "D E F",
                ["D", "E", "F"],
                "ExistingGemA==1.0.0 GemB",
                None,
                None,
                [
                    "ExistingGemA==1.0.0",
                    {"name": "ExistingGemB", "optional": True},
                    "GemB",
                ],
                "NewEngineName",
                "o3de>=1.0",
            ...
            pytest.param(
                ...
                ["GemA"],
                None,
                ["GemB", "ExistingGemA", {"name": "ExistingGemB", "optional": True}],
                "o3de-sdk",
                "c==4.3.2.1",
                None,
                "a>=0.1 b==1.0,==2.0",
            ...
            pytest.param(
                ...
                None,
                "",
                ["ExistingGemA", {"name": "ExistingGemB", "optional": True}],
                "o3de-custom==1.0.0",
                None,
                None,
                [],
            ...
            pytest.param(
                ...
                None,
                ["GemC"],
                ["GemC", "ExistingGemA", {"name": "ExistingGemB", "optional": True}],
                None,
                None,
                None,
                "o3de-sdk==2205.1",
    ...
    def test_edit_project_properties(
        ...
        expected_gem_names,
        engine_name,
        add_compatible_engines,
        delete_compatible_engines,
        replace_compatible_engines,
        expected_compatible_engines,
        add_engine_api_dependencies,
        remove_engine_api_dependencies,
        ...
        with (
            ...
            if result == 0:
                ...
                assert (
                    self.project_json.data.get("project_name", "") == project_new_name
                )
                ...
                expected_project_json_path = (
                    project_path if not user else project_path / "user"
                )
                expected_project_json_path /= "project.json"
                assert (
                    self.project_json.path.as_posix()
                    == expected_project_json_path.as_posix()
                )

                if engine_path:
                    engine_path = engine_path.as_posix() if engine_path.name else None
                assert self.project_json.data.get("engine_path") == (
                    engine_path if user else None
                )
                assert self.project_json.data.get("engine_finder_cmake_path") == (
                    engine_finder_cmake_path.as_posix()
                    if engine_finder_cmake_path
                    else None
                )
                ...
                assert set(self.project_json.data.get("user_tags", [])) == set(
                    expected_tags
                )
                ...
                assert set(self.project_json.data.get("compatible_engines", [])) == set(
                    expected_compatible_engines
                )
                assert set(
                    self.project_json.data.get("engine_api_dependencies", [])
                ) == set(expected_engine_api_dependencies)
