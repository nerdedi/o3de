...
TEST_GEM_JSON_PAYLOAD = {
    "gem_name": "TestGem",
    "version": "0.0.0",
    "compatible_engines": ["o3de-sdk==1.2.3"],
    "engine_api_dependencies": ["framework==1.2.3"],
...
TEST_PROJECT_JSON_PAYLOAD = {
    ...
    "user_tags": ["ProjectSample"],
    "icon_path": "preview.png",
    "engine": "o3de",
    "external_subdirectories": ["Gem"],
    "gem_names": ["Kaylin", "Gene"],
...
TEST_TEMPLATE_JSON_PAYLOAD = {"template_name": "MinimalProject"}

GEM_VERSION_ONE_JSON = {"gem_name": "TestGem", "version": "1.0.0"}

GEM_VERSION_TWO_JSON = {"gem_name": "TestGem", "version": "2.0.0"}

GEM_VERSION_THREE_JSON = {"gem_name": "TestGem", "version": "3.0.0"}
...
GEM_WITH_NO_VERSION = {"gem_name": "TestGem"}

JSON_DICT = {
    "gem_version1_json_key": GEM_VERSION_ONE_JSON,
...
class TestEditRepoProperties:
    ...
    @pytest.mark.parametrize(
        ...
        [
            # test add gems
            pytest.param(
                pathlib.Path("F:/repotest"),
                "Repotest1",
                "gem1 gem3",
                None,
                None,
                [{"gem_name": "gem1"}, {"gem_name": "gem3"}],
                None,
                None,
                None,
                None,
            ...
            pytest.param(
                pathlib.Path("F:/repotest/AFH"),
                "Repotest3",
                "gem1 gem2",
                None,
                "gem3 gem4",
                [{"gem_name": "gem3"}, {"gem_name": "gem4"}],
                None,
                None,
                None,
                None,
            ...
            pytest.param(
                ...
                None,
                None,
                [{"project_name": "project1"}, {"project_name": "project2"}],
                None,
                None,
                None,
                None,
            ...
            pytest.param(
                ...
                "project2",
                None,
                [{"project_name": "project1"}, {"project_name": "project3"}],
                None,
                None,
                None,
                None,
            ...
            pytest.param(
                ...
                None,
                None,
                [{"template_name": "template1"}, {"template_name": "template2"}],
                None,
                None,
                None,
                None,
            ...
            pytest.param(
                pathlib.Path("F:/repotest"),
                "GemAddVersion",
                "gem_version1_json_key gem_version2_json_key",
                None,
                None,
                [
                    {
            ...
            pytest.param(
                pathlib.Path("F:/repotest"),
                "GemAddAndRemoveVersion",
                "gem_version1_json_key gem_version2_json_key",
                "TestGem==2.0.0",
                None,
                [{"gem_name": "TestGem", "version": "1.0.0", "versions_data": []}],
                None,
                None,
                None,
                None,
            ...
            pytest.param(
                pathlib.Path("F:/repotest"),
                "GemAddAndRemoveBaseVersion",
                "gem_version1_json_key gem_version2_json_key",
                "TestGem==1.0.0",
                None,
                [{"gem_name": "TestGem", "version": "2.0.0", "versions_data": []}],
                None,
                None,
                None,
                None,
            ...
            pytest.param(
                pathlib.Path("F:/repotest"),
                "GemAddAndRemoveAllVersion",
                "gem_version1_json_key gem_version2_json_key",
                "TestGem==1.0.0 TestGem==2.0.0",
                None,
                [],
                None,
                None,
            ...
            pytest.param(
                pathlib.Path("F:/repotest"),
                "GemAddSameVersionWithUpdateField",
                "gem_version1_tobe_updated_key gem_version1_with_updated_field_key",
                None,
                None,
                [
                    {
            ...
            pytest.param(
                pathlib.Path("F:/repotest"),
                "GemAddSameVersionWithUpdateField",
                "gem_version1_json_key gem_version2_tobe_updated_key gem_version2_updated_key",
                None,
                None,
                [
                    {
                        ...
                        "version": "1.0.0",
                        "versions_data": [
                            {"version": "2.0.0", "display_name": "hiWorld"}
                        ],
                    }
                ],
                None,
            ...
            pytest.param(
                ...
                "gem_version1_json_key gem_version2_json_key",
                None,
                "gem_version3_json_key",
                [{"gem_name": "TestGem", "version": "3.0.0"}],
                None,
                None,
                None,
                None,
            ...
            pytest.param(
                pathlib.Path("F:/repotest"),
                "DeletingGemVersion",
                "gem_version1_json_key gem_version2_json_key gem_version3_json_key",
                "TestGem>2.0.0",
                None,
                [
                    {
            ...
            pytest.param(
                pathlib.Path("F:/repotest"),
                "GemAddSameVersionWithUpdateField",
                "gem_with_no_version_key gem_version1_json_key",
                None,
                None,
                [{"gem_name": "TestGem", "versions_data": [{"version": "1.0.0"}]}],
                None,
                None,
                None,
                None,
            ...
            pytest.param(
                ...
                None,
                None,
                [JSON_DICT["gem_archive_json_key"]],
                None,
                None,
                None,
                None,
    ...
    def test_edit_repo_obj_version(
        self,
        temp_folder,
        repo_path,
        repo_name,
        ...
        def save_o3de_manifest(
            json_data: dict, manifest_path: pathlib.Path = None
        ) -> bool:
        ...
        def _auto_update_json(
            object_type: str or list = None,
            repo_path: pathlib.Path = None,
            repo_json: dict = None,
        ):
            objects = (
                object_type.split() if isinstance(object_type, str) else object_type
            )
            for object_type in objects:
                if object_type == "gem":
                    self.repo_json.data.get("gems_data").append(
                        str(JSON_DICT["gem_archive_json_key"])
                    )
                if object_type == "project":
                    self.repo_json.data.get("projects_data").append(
                        str(JSON_DICT["project_json_key"])
                    )
                if object_type == "template":
                    self.repo_json.data.get("templates_data").append(
                        str(JSON_DICT["template_json_key"])
                    )
                if object_type == "dry-run":
                    self.repo_json.data.get("gems_data").append(
                        json.loads(TEST_GEM_JSON_STR)
                    )
                    self.repo_json.data.get("projects_data").append(
                        json.loads(TEST_PROJECT_JSON_STR)
                    )
                    self.repo_json.data.get("templates_data").append(
                        json.loads(TEST_TEMPLATE_JSON_STR)
                    )
            return 0
        ...
        with (
            patch(
                "o3de.repo_properties.get_repo_props", side_effect=get_repo_props
            ) as get_repo_props_patch,
            patch(
                "o3de.manifest.save_o3de_manifest", side_effect=save_o3de_manifest
            ) as save_o3de_manifest_patch,
            patch(
                "o3de.utils.backup_file", side_effect=backup_file
            ) as backup_file_patch,
            patch(
                "o3de.repo_properties._auto_update_json", side_effect=_auto_update_json
            ) as _auto_update_json_patch,
            patch(
                "o3de.manifest.get_json_data", side_effect=get_json_data
            ) as get_json_data_patch,
            patch(
                "logging.Logger.warning", side_effect=mock_dryrun_print
            ) as logger_warning_patch,
        ):
            if release_archive_path:
                add_gems = [temp_folder / "gem"]
                release_archive_path = temp_folder / "release"
            result = repo_properties.edit_repo_props(
                repo_path,
                repo_name,
                add_gems,
                delete_gems,
                ...
                if dry_run:
                    ...
                    for gem in self.repo_json.data.get("gems_data", []):
                        if release_archive_path:
                            zip_path = (
                                release_archive_path
                                / pathlib.Path(gem["download_source_uri"]).name
                            )
                            download.validate_downloaded_zip_sha256(
                                gem, zip_path, "gem.json"
                            )
                        elif auto_update:
