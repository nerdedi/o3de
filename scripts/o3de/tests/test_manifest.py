...
class TestGetEnabledGems:
    ...
    def test_get_enabled_gems(self, enable_gems_cmake_data, expected_set):
        ...
        with (
            patch(
                "pathlib.Path.resolve", return_value=pathlib.Path("enabled_gems.cmake")
            ) as pathlib_is_resolve_mock,
            patch("pathlib.Path.is_file", return_value=True) as pathlib_is_file_mock,
            patch(
                "pathlib.Path.open", return_value=io.StringIO(enable_gems_cmake_data)
            ) as pathlib_open_mock,
        ):
            enabled_gems_set = manifest.get_enabled_gems(
                pathlib.Path("enabled_gems.cmake")
            )
...
@pytest.mark.parametrize(
    "valid_project_json_paths, valid_gem_json_paths",
    [
        pytest.param(
            [pathlib.Path("D:/o3de/Templates/DefaultProject/Template/project.json")],
...
class TestGetTemplatesForCreation:
    ...
    def get_engine_templates() -> list:
        return [
            pathlib.Path("D:/o3de/Templates/DefaultProject"),
            pathlib.Path("D:/o3de/Templates/DefaultGem"),
        ]
    ...
    @pytest.mark.parametrize("expected_template_paths", [pytest.param([])])
    def test_get_templates_for_generic_creation(
        self, valid_project_json_paths, valid_gem_json_paths, expected_template_paths
    ):
        ...
        with (
            patch(
                "o3de.manifest.get_manifest_templates",
                side_effect=self.get_manifest_templates,
            ) as get_manifest_templates_patch,
            patch(
                "o3de.manifest.get_project_templates",
                side_effect=self.get_project_templates,
            ) as get_project_templates_patch,
            patch(
                "o3de.manifest.get_gem_templates", side_effect=self.get_gem_templates
            ) as get_gem_templates_patch,
            patch(
                "o3de.manifest.get_engine_templates",
                side_effect=self.get_engine_templates,
            ) as get_engine_templates_patch,
            patch(
                "o3de.manifest.get_all_gems", side_effect=self.get_all_gems
            ) as get_all_gems_patch,
            patch(
                "o3de.validation.valid_o3de_template_json", return_value=True
            ) as validate_template_json,
            patch(
                "o3de.validation.valid_o3de_project_json",
                side_effect=validate_project_json,
            ) as validate_project_json,
            patch(
                "o3de.validation.valid_o3de_gem_json", side_effect=validate_gem_json
    ...
    def test_get_templates_for_gem_creation(
        self, valid_project_json_paths, valid_gem_json_paths, expected_template_paths
    ):
        def validate_project_json(project_json_path) -> bool:
            return pathlib.Path(project_json_path) in valid_project_json_paths
...
class TestGetAllGems:
    ...
    @pytest.mark.parametrize(
        """manifest_external_subdirectories,
        ...
        [
            pytest.param(
                ...
                [
                    "D:/GemOutsideEngine",
                    "D:/o3de/o3de/GemInEngine",
                    "D:/GemOutsideEngine/GemInGem",
                    "D:/o3de/o3de/GemInEngine/GemInGem",
                ],
            ),
            pytest.param(
                ["D:/GemOutsideEngine", "D:/GemOutsideEngine", "D:/NonGem"],
    ...
    def test_get_all_gems_returns_unique_paths(
        self,
        manifest_external_subdirectories,
        engine_external_subdirectories,
        gem_external_subdirectories,
        ...
        def load_o3de_manifest(manifest_path: pathlib.Path = None) -> dict:
            ...
            manifest_payload["external_subdirectories"] = (
                manifest_external_subdirectories
            )
        ...
        with (
            patch(
                "o3de.manifest.get_gem_json_data", side_effect=get_gem_json_data
            ) as get_gem_json_data_patch,
            patch(
                "o3de.manifest.get_engine_json_data", side_effect=get_engine_json_data
            ) as get_engine_json_data_patch,
            patch(
                "o3de.manifest.get_this_engine_path",
                side_effect=self.get_this_engine_path,
            ...
            patch(
                "o3de.manifest.load_o3de_manifest", side_effect=load_o3de_manifest
    ...
    @pytest.mark.parametrize(
        ...
        [
            pytest.param({"Gems/Gem1": ["../Gem2"], "Gems/Gem2": ["../Gem1"]}, True),
            pytest.param(
                {
                    "Gems/Gem1": ["Gem2"],
    ...
    def test_get_gem_external_subdirectories_detects_cycles(
        self, gem_external_subdirectories, expected_cycle_detected
    ):
        def get_gem_json_data(
            gem_name: str = None,
            gem_path: str or pathlib.Path = None,
...
class TestGetProjectEnabledGems:
    ...
    @pytest.mark.parametrize(
        """project_gem_names, cmake_gem_names, 
                    ...
                    "GemA": [
                        {
                            "gem_name": "GemA",
                            "version": "1.0.0",
                            "path": pathlib.Path("c:/GemA1"),
                        },
                        {
                            "gem_name": "GemA",
                            "version": "2.0.0",
                            "path": pathlib.Path("c:/GemA2"),
                        },
                    ],
                    "GemB": [{"gem_name": "GemB", "path": pathlib.Path("c:/GemB")}],
                },
    ...
    def test_get_project_enabled_gems(
        self,
        project_gem_names,
        cmake_gem_names,
        all_gems_json_data,
        ...
        with (
            ...
            patch(
                "o3de.manifest.get_gems_json_data_by_name",
                side_effect=get_gems_json_data_by_name,
            ) as get_gems_json_data_by_name_patch,
            patch(
                "o3de.manifest.get_project_json_data", side_effect=get_project_json_data
            ) as get_project_json_data_patch,
            patch(
                "o3de.manifest.get_project_engine_path",
                side_effect=get_project_engine_path,
            ) as get_project_engine_path_patch,
            patch(
                "o3de.manifest.get_enabled_gem_cmake_file",
                side_effect=get_enabled_gem_cmake_file,
            ) as get_enabled_gem_cmake_file_patch,
            patch(
                "o3de.manifest.get_enabled_gems", side_effect=get_enabled_gems
            ) as get_enabled_gems_patch,
            patch("pathlib.Path.resolve", self.resolve) as resolve_patch,
            patch("pathlib.Path.is_file", return_value=True) as is_file_patch,
        ):
            assert expected_result == manifest.get_project_enabled_gems(
                self.project_path, include_dependencies
            )
...
class TestManifestGetRegistered:
    ...
    @pytest.mark.parametrize(
        "template_name, relative_template_path, expected_path",
        [
            pytest.param(
                "DefaultProject",
                pathlib.Path("Templates/DefaultProject"),
                pathlib.Path("D:/o3de/o3de/Templates/DefaultProject"),
            ),
            pytest.param(
                "InvalidProject", pathlib.Path("Templates/DefaultProject"), None
            ),
        ],
    )
    def test_get_registered_template(
        self, template_name, relative_template_path, expected_path
    ):
        def get_engine_json_data(
            engine_name: str = None, engine_path: str or pathlib.Path = None
        ) -> dict or None:
        ...
        def get_gem_json_data(
            gem_name: str = None, gem_path: str or pathlib.Path = None
        ) -> dict or None:
            gem_payload = json.loads(TEST_GEM_JSON_PAYLOAD)
            return gem_payload
        ...
        with (
            ...
            patch(
                "pathlib.Path.open",
                return_value=io.StringIO(TEST_PROJECT_TEMPLATE_JSON_PAYLOAD),
            ) as _7,
...
@pytest.mark.parametrize(
    "test_object_typename",
    [pytest.param("engine"), pytest.param("project"), pytest.param("gem")],
)
class TestManifestGetRegisteredVersionedObject:
    ...
    @pytest.mark.parametrize(
        "object_name, json_data_by_path, expected_path",
        [
            # when no version information exists and name matches expect object not found
            pytest.param(
                "object-name",
                {pathlib.PurePath("object1"): {"name": "object-name"}},
    ...
    def test_get_registered_object_with_version(
        self, test_object_typename, object_name, json_data_by_path, expected_path
    ):
        def get_json_data(
            object_typename: str,
        ...
        def load_o3de_manifest(manifest_path: pathlib.Path = None) -> dict:
            ...
            if test_object_typename == "gem":
                manifest_payload["external_subdirectories"] = [
                    p.as_posix() for p in json_data_by_path.keys()
                ]
            else:
                manifest_payload[test_object_typename + "s"] = [
                    p.as_posix() for p in json_data_by_path.keys()
                ]
            return manifest_payload
        ...
        with (
            ...
            path = manifest.get_registered(
                engine_name=engine_name, project_name=project_name, gem_name=gem_name
            )
            assert path == expected_path
...
class TestManifestProjects:
    ...
    @pytest.mark.parametrize(
        "project_path, project_engine, user_project_json, engines, engines_json_data, \
                expected_engine_path",
        [
            pytest.param(
                pathlib.Path("C:/project1"),
                "engine1",
                None,
            ...
            pytest.param(
                pathlib.Path("C:/engine1/project1"),
                "",
                {},
                [pathlib.Path("C:/engine1"), pathlib.Path("D:/engine2")],
                [{"engine_name": "engine1"}, {"engine_name": "engine2"}],
            ...
            pytest.param(
                ...
                [
                    {"engine_name": "o3de", "version": "1.0.0"},
                    {"engine_name": "o3de", "version": "1.0.0"},
                ],
            ...
            pytest.param(
                pathlib.Path("C:/project1"),
                "o3de",
                {"engine_path": pathlib.Path("D:/o3de2")},
                [pathlib.Path("C:/o3de1"), pathlib.Path("D:/o3de2")],
                [
                    {"engine_name": "o3de", "version": "1.0.0"},
                    {"engine_name": "o3de", "version": "1.0.0"},
            ...
            pytest.param(
                ...
                [
                    {"engine_name": "o3de", "version": "1.0.0"},
                    {"engine_name": "o3de", "version": "2.0.0"},
                ],
                pathlib.Path("D:/o3de2"),
            ),
    ...
    def test_get_project_engines(
        ...
        def find_ancestor_dir_containing_file(
            target_file_name: pathlib.PurePath,
            start_path: pathlib.Path,
            max_scan_up_range: int = 0,
        ...
        with (
            ...
            patch(
                "o3de.manifest.get_json_data_file", side_effect=get_json_data_file
            ) as get_json_data_file_patch,
            patch("o3de.manifest.get_registered", side_effect=get_registered) as _2,
            patch(
                "o3de.manifest.get_manifest_engines", side_effect=get_manifest_engines
            ) as _3,
            patch(
                "o3de.manifest.get_engine_projects", side_effect=get_engine_projects
            ) as _4,
            patch(
                "o3de.utils.find_ancestor_dir_containing_file",
                side_effect=find_ancestor_dir_containing_file,
            ) as _5,
            patch("pathlib.Path.is_file", new=is_file) as pathlib_is_file_mock,
...
class TestManifestGetGemsJsonData:
    ...
    @pytest.mark.parametrize(
        "engine_path, project_path, include_manifest_gems, include_engine_gems,"
        ...
        [
            ...
            pytest.param(
                ...
                {
                    "engine_gem1": [
                        {"gem_name": "engine_gem1", "path": pathlib.Path("engine_gem1")}
                    ]
                },
            ),
            ...
            pytest.param(
                ...
                list(),
                {
                    "project_gem1": [
                        {
                            "gem_name": "project_gem1",
                            "path": pathlib.Path("project_gem1"),
                        }
                    ]
                },
            ),
            ...
            pytest.param(
                ...
                list(),
                {
                    "manifest_gem1": [
                        {
                            "gem_name": "manifest_gem1",
                            "path": pathlib.Path("manifest_gem1"),
                        }
                    ]
                },
            ),
            ...
            pytest.param(
                ...
                ["external_gem1"],
                {
                    "external_gem1": [
                        {
                            "gem_name": "external_gem1",
                            "external_subdirectories": ["external_sub_gem2"],
                            "path": pathlib.Path("external_gem1"),
                        }
                    ],
                    "external_sub_gem2": [
                        {
                            "gem_name": "external_sub_gem2",
                            "path": pathlib.Path("external_gem1/external_sub_gem2"),
                        }
                    ],
                },
            ),
            ...
            pytest.param(
                ...
                False,
                False,
                ["external_gem_v1", "external_gem_v2"],
                {
                    "versioned_gem": [
                        {
                            "gem_name": "versioned_gem",
                            "version": "1.0.0",
                            "path": pathlib.Path("external_gem_v1"),
                        },
                        {
                            "gem_name": "versioned_gem",
                            "version": "2.0.0",
                            "path": pathlib.Path("external_gem_v2"),
                        },
                    ],
                },
            ),
    ...
    def test_get_gems_json_data_by_name(
        self,
        engine_path,
        project_path,
        ...
        def get_engine_external_subdirectories(
            engine_path: pathlib.Path = None,
        ) -> list:
        ...
        with (
            ...
            patch(
                "o3de.manifest.get_manifest_external_subdirectories",
                side_effect=get_manifest_external_subdirectories,
            ) as get_manifest_external_subdirs_patch,
            patch(
                "o3de.manifest.get_engine_external_subdirectories",
                side_effect=get_engine_external_subdirectories,
            ) as get_engine_external_subdirs_patch,
            patch(
                "o3de.manifest.get_project_external_subdirectories",
                side_effect=get_project_external_subdirectories,
            ) as get_project_external_subdirs_patch,
            patch(
                "o3de.manifest.get_project_engine_path",
                side_effect=get_project_engine_path,
            ) as get_project_engine_path_patch,
            ...
            all_gems_by_name = manifest.get_gems_json_data_by_name(
...
class TestManifestRemoveNonDependencyGemJsonData:
    @pytest.mark.parametrize(
        "top_level_gem_names, gems_json_data_by_name, expected_result",
        [
    ...
    def test_remove_non_dependency_gem_json_data(
        self, top_level_gem_names, gems_json_data_by_name, expected_result
    ):
        manifest.remove_non_dependency_gem_json_data(
            gem_names=top_level_gem_names, gems_json_data_by_name=gems_json_data_by_name
        )
