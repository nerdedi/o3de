...
class TestTiafDriver:
    def test_run_Tiaf_mars_index_prefix_is_supplied(
        self, caplog, main_args, skip_if_test_targets_disabled, mock_runtime, mocker
    ):
        # given:
    ...
    def test_run_Tiaf_mars_index_prefix_is_not_supplied(
        self, caplog, main_args, skip_if_test_targets_disabled, mock_runtime, mocker
    ):
        # given:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ("native", "test_impact.native_test_impact.NativeTestImpact.__init__"),
            ("python", "test_impact.python_test_impact.PythonTestImpact.__init__"),
        ],
    )
    def test_run_Tiaf_driver_runtime_type_selection(
        self,
        caplog,
        tiaf_args,
        skip_if_test_targets_disabled,
        mock_runtime,
        mocker,
        runtime_type,
        mock_type,
...
class TestTiafInitialiseStorage:
    def skip_if_test_targets_disabled(skip_if_test_targets_disabled):
        if not skip_if_test_targets_disabled:
            pytest.skip(
                "Test targets are disabled for this runtime, test will be skipped."
            )
    ...
    def test_create_TestImpact_no_s3_bucket_name(
        self,
        caplog,
        tiaf_args,
        skip_if_test_targets_disabled,
        ...
        expected_storage_args = (
            ...
            tiaf_args["suites"],
            tiaf_args["commit"],
            storage_config["active_workspace"],
            storage_config["unpacked_coverage_data_file"],
            storage_config["previous_test_run_data_file"],
            storage_config["historic_workspace"],
            storage_config["historic_data_file"],
            storage_config["temp_workspace"],
        )
        mock_local = mocker.patch(
            "persistent_storage.PersistentStorageLocal.__init__",
        ...
        assert_list_content_equal(
            self.to_list(mock_local.call_args[0]).pop(),
            self.to_list(expected_storage_args).pop(),
        )

    @pytest.mark.parametrize(
        "bucket_name,top_level_dir,expected_top_level_dir",
        [("test_bucket", "test_dir", "test_dir/native")],
    )
    def test_create_TestImpact_s3_bucket_name_supplied(
        self,
        caplog,
        tiaf_args,
        skip_if_test_targets_disabled,
    ...
    def test_create_TestImpact_s3_bucket_name_not_supplied(
        self,
        caplog,
        tiaf_args,
        skip_if_test_targets_disabled,
    ...
    def test_create_TestImpact_s3_top_level_dir_bucket_name_not_supplied(
        self,
        caplog,
        tiaf_args,
        skip_if_test_targets_disabled,
...
class TestTIAFNativeUnitTests:
    ...
    def test_create_NativeTestImpact_safe_mode_arguments(
        self,
        caplog,
        tiaf_args,
        skip_if_test_targets_disabled,
        mock_runtime,
        cpp_default_runtime_args,
        safemode,
        arg_val,
    ):
        # given:
        ...
        assert_list_content_equal(tiaf.runtime_args, cpp_default_runtime_args.values())

    def test_create_NativeTestImpact_no_safe_mode(
        self,
        caplog,
        tiaf_args,
        skip_if_test_targets_disabled,
    ...
    def test_create_NativeTestImpact_correct_s3_dir_runtime_type(
        self,
        config_data,
        caplog,
        tiaf_args,
...
class TestTIAFPythonUnitTests:
    ...
    @pytest.mark.parametrize(
        "bucket_name,top_level_dir,expected_top_level_dir",
        [("test_bucket", "test_dir", "test_dir/python")],
    )
    def test_create_PythonTestImpact_correct_s3_dir_runtime_type(
        self,
        config_data,
        caplog,
        tiaf_args,
...
class TestTIAFBaseUnitTests:
    ...
    def test_create_TestImpact_valid_config(
        self,
        caplog,
        tiaf_args,
        skip_if_test_targets_disabled,
        ...
        assert_list_content_equal(tiaf.runtime_args, default_runtime_args.values())

    def test_create_TestImpact_invalid_config(
        self,
        caplog,
        tiaf_args,
        skip_if_test_targets_disabled,
    ...
    def test_create_TestImpact_src_branch(
        self,
        caplog,
        tiaf_args,
        skip_if_test_targets_disabled,
    ...
    @pytest.mark.parametrize("branch_name", ["development", "not_a_real_branch"])
    def test_create_TestImpact_dst_branch(
        self,
        caplog,
        tiaf_args,
        skip_if_test_targets_disabled,
    ...
    @pytest.mark.parametrize(
        "commit", ["9a15f038807ba8b987c9e689952d9271ef7fd086", "foobar"]
    )
    def test_create_TestImpact_commit(
        self,
        caplog,
        tiaf_args,
        skip_if_test_targets_disabled,
    ...
    def test_create_TestImpact_valid_test_suite_name(
        self,
        caplog,
        tiaf_args,
        skip_if_test_targets_disabled,
    ...
    def test_create_TestImpact_invalid_test_suite_name(
        self,
        caplog,
        tiaf_args,
        skip_if_test_targets_disabled,
    ...
    def test_create_TestImpact_valid_failure_policy(
        self,
        caplog,
        tiaf_args,
        skip_if_test_targets_disabled,
    ...
    def test_create_TestImpact_exclude_file_not_supplied(
        self,
        caplog,
        tiaf_args,
        skip_if_test_targets_disabled,
    ...
    def test_create_TestImpact_exclude_file_supplied(
        self,
        caplog,
        tiaf_args,
        skip_if_test_targets_disabled,
